"use strict";(()=>{var ve=Object.defineProperty;var Te=(a,e,t)=>e in a?ve(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t;var p=(a,e,t)=>(Te(a,typeof e!="symbol"?e+"":e,t),t);var ee=CodeMirror.Pos,Ee=["arrays","benchmark","bitfield","cli","clipboard","compress","context","crypto","darwin","datatypes","dl","dlmalloc","encoding","eventbus","flag","fontstash","gg","gx","hash","io","js","json","log","math","mssql","mysql","net","orm","os","pg","picoev","picohttpparser","rand","readline","regex","runtime","semver","sokol","sqlite","stbi","strconv","strings","sync","szip","term","time","toml","v","vweb","x"],ce=["params","noinit","required","skip","assert_continues","unsafe","manualfree","heap","nonnull","primary","inline","direct_array_access","live","flag","noinline","noreturn","typedef","console","sql","table","deprecated","deprecated_after","export","callconv"],te="[\\w_]+",de=new RegExp(`^(${ce.join("|")})]$`),pe=`(${te}: ${te})`,he=new RegExp(`^${pe}]$`),me=new RegExp(`^(${ce.join("|")}(; ?)?){2,}]$`),ge=new RegExp(`^((${pe})(; )?){2,}]$`),fe=new RegExp(`^if ${te} \\??]`);function Se(a){let e=[],t=a.getCursor(),n=a.getTokenAt(t),o=new Set;for(let g=0;g<Math.min(a.lineCount(),10);g++){let f=a.getLineTokens(g).filter(b=>b.type!=null);f.length>0&&f[0].string==="import"&&o.add(f[f.length-1].string)}let u=a.getLineTokens(t.line);u.length>0&&u[0].string==="import"&&e.push(u[0]);let l=n.string.length,c=a.getTokenAt(ee(t.line,t.ch-l));return n.string==="."&&e.push(n),c.string==="."&&e.push(c),/\b(?:string|comment)\b/.test(n.type??"")?null:(/^[\w$_]*$/.test(n.string)?n.end>t.ch&&(n.end=t.ch,n.string=n.string.slice(0,t.ch-n.start)):n={start:t.ch,end:t.ch,string:"",state:n.state,type:n.string==="."?"property":null},{list:Le(n,o,e),from:ee(t.line,n.start),to:ee(t.line,n.end)})}function Le(a,e,t){let n=[],o=a.string;function u(l){let c=l.text;if(!c.startsWith(o))return;n.find(f=>f.text===c)||n.push(l)}if(t&&t.length){let l=t.pop();if(l!==void 0){if(l.type==="keyword"&&l.string==="import")return Ee.forEach(c=>{u({text:c,displayText:c,className:"completion-module"})}),n;if(l.string===".")return[]}}return e.forEach(l=>{u({text:l,displayText:l,className:"completion-module"})}),$.forEach(l=>{u({text:l+" ",displayText:l,className:"completion-keyword"})}),ne.forEach(l=>{u({text:l+" ",displayText:l,className:"completion-keyword"})}),ie.forEach(l=>{u({text:l,displayText:l,className:"completion-atom"})}),re.forEach(l=>{u({text:l,displayText:l,className:"completion-type"})}),n}var xe=a=>Se(a);CodeMirror.registerHelper("hint","v",xe);var D=class{constructor(e,t,n,o,u,l=new Set){this.indentation=e;this.column=t;this.type=n;this.align=o;this.prev=u;this.knownImports=l}insideString=!1;stringQuote=null;expectedImportName=!1},$=new Set(["as","asm","assert","atomic","break","const","continue","defer","else","enum","fn","for","go","goto","if","import","in","interface","is","isreftype","lock","match","module","mut","none","or","pub","return","rlock","select","shared","sizeof","static","struct","spawn","type","typeof","union","unsafe","volatile","__global","__offsetof"]),ne=new Set(["sql","chan","thread"]),_e=new Set(["#flag","#include","#pkgconfig"]),ie=new Set(["true","false","nil","print","println","exit","panic","error","dump"]),re=new Set(["bool","string","i8","i16","int","i32","i64","i128","u8","u16","u32","u64","u128","rune","f32","f64","isize","usize","voidptr","any"]);CodeMirror.defineMode("v",a=>{let e=a.indentUnit??0,t=/[+\-*&^%:=<>!?|\/]/,n=null;function o(i){return i.eatWhile(/[\w$_\xa1-\uffff]/),i.current()}function u(i,r){let s=i.next();if(s===null)return null;if(r.context.insideString&&s==="}")return i.eat("}"),r.tokenize=m(r.context.stringQuote),"end-interpolation";if(s==='"'||s==="'"||s==="`")return r.tokenize=m(s),r.tokenize(i,r);if((s==="r"||s==="c")&&(i.peek()=='"'||i.peek()=="'")){let _=i.next();return _===null||(r.tokenize=x(_)),"string"}if(s==="."&&!i.match(/^[0-9]+([eE][\-+]?[0-9]+)?/))return"operator";if(s==="["&&(i.match(de)||i.match(he)||i.match(me)||i.match(ge)||i.match(fe)))return"attribute";if(/[\d.]/.test(s))return s==="0"?i.match(/^[xX][0-9a-fA-F_]+/)||i.match(/^o[0-7_]+/)||i.match(/^b[0-1_]+/):i.match(/^[0-9_]*\.?[0-9_]*([eE][\-+]?[0-9_]+)?/),"number";if(/[\[\]{}(),;:.]/.test(s))return n=s,null;if(s==="/"){if(i.eat("*"))return r.tokenize=E,E(i,r);if(i.eat("/"))return i.skipToEnd(),"comment"}if(t.test(s))return i.eatWhile(t),"operator";if(s==="@")return o(i),"at-identifier";if(s==="$"){let _=o(i).slice(1);return $.has(_)?"keyword":"compile-time-identifier"}i.backUp(2);let h=i.next()===".";i.next();let d=o(i);if(d==="import"&&(r.context.expectedImportName=!0),$.has(d)||ne.has(d))return"keyword";if(ie.has(d))return"atom";if(_e.has(d))return"hash-directive";if(!h&&re.has(d))return"builtin";if(d.length>0&&d[0].toUpperCase()===d[0])return"type";let S=i.peek();if(S==="("||S==="<")return"function";if(S==="["){i.next();let _=i.next();if(i.backUp(2),_!=null&&_.match(/[A-Z]/i))return"function"}return r.context.expectedImportName&&i.peek()!=="."?(r.context.expectedImportName=!1,r.context.knownImports===void 0&&(r.context.knownImports=new Set),r.context.knownImports.add(d),"import-name"):h?"property":r.context.knownImports.has(d)&&i.peek()=="."?"import-name":"variable"}function l(i,r){return i.match("}")?(r.tokenize=m(r.context.stringQuote),"end-interpolation"):(r.tokenize=u,r.tokenize(i,r))}function c(i,r){let s=i.next();if(s===" ")return r.tokenize=m(r.context.stringQuote),r.tokenize(i,r);if(s===".")return"operator";let h=o(i);if(h[0].toLowerCase()===h[0].toUpperCase())return r.tokenize=m(r.context.stringQuote),r.tokenize(i,r);let d=i.next();return i.backUp(1),d==="."?r.tokenize=c:r.tokenize=m(r.context.stringQuote),"variable"}function g(i,r){let s=i.next();return s==="$"&&i.eat("{")?(r.tokenize=l,"start-interpolation"):s==="$"?(r.tokenize=c,"start-interpolation"):"string"}function f(i,r){return i.next()==="\\"?(i.next(),r.tokenize=m(r.context.stringQuote),"valid-escape"):"string"}function b(i){return i==="n"||i==="t"||i==="r"||i==="\\"||i==='"'||i==="'"||i==="0"}function m(i){return function(r,s){s.context.insideString=!0,s.context.stringQuote=i;let h="",d=!1,S=!1;for(;(h=r.next())!=null;){if(h===i&&!d){S=!0;break}if(h==="$"&&!d&&r.eat("{"))return s.tokenize=g,r.backUp(2),"string";if(h==="$"&&!d)return s.tokenize=g,r.backUp(1),"string";if(d&&b(h))return r.backUp(2),s.tokenize=f,"string";d=!d&&h==="\\"}return(S||d)&&(s.tokenize=u),s.context.insideString=!1,s.context.stringQuote=null,"string"}}function x(i){return function(r,s){s.context.insideString=!0,s.context.stringQuote=i;let h="",d=!1,S=!1;for(;(h=r.next())!=null;){if(h===i&&!d){S=!0;break}d=!d&&h==="\\"}return(S||d)&&(s.tokenize=u),s.context.insideString=!1,s.context.stringQuote=null,"string"}}function E(i,r){let s=!1,h;for(;h=i.next();){if(h==="/"&&s){r.tokenize=u;break}s=h==="*"}return"comment"}function A(i,r,s){return i.context=new D(i.indention,r,s,null,i.context,i.context.knownImports)}function z(i){if(!i.context.prev)return;let r=i.context.type;return(r===")"||r==="]"||r==="}")&&(i.indention=i.context.indentation),i.context=i.context.prev,i.context}return{startState:function(){return{tokenize:null,context:new D(0,0,"top",!1),indention:0,startOfLine:!0}},token:function(i,r){let s=r.context;if(i.sol()&&(s.align==null&&(s.align=!1),r.indention=i.indentation(),r.startOfLine=!0),i.eatSpace())return null;n=null;let h=(r.tokenize||u)(i,r);return h==="comment"||(s.align==null&&(s.align=!0),n==="{"?A(r,i.column(),"}"):n==="["?A(r,i.column(),"]"):n==="("?A(r,i.column(),")"):(n==="}"&&s.type==="}"||n===s.type)&&z(r),r.startOfLine=!1),h},indent:function(i,r){if(i.tokenize!==u&&i.tokenize!=null||i.context.type=="top")return 0;let s=i.context,d=r.charAt(0)===s.type;return s.align?s.column+(d?0:1):s.indentation+(d?0:e)},electricChars:"{}):",closeBrackets:"()[]{}''\"\"``",fold:"brace",blockCommentStart:"/*",blockCommentEnd:"*/",lineComment:"//"}});CodeMirror.defineMIME("text/x-v","v");var V=class{hash;constructor(e){this.hash=e}saveCode(e){}getCode(e){return this.getSharedCode(e)}getSharedCode(e){let t=new FormData;t.append("hash",this.hash),fetch("/query",{method:"post",body:t}).then(n=>n.json()).then(n=>n).then(n=>{if(console.log(n),!n.found){e({code:V.CODE_NOT_FOUND});return}if(n.error!=""){console.error(n.error),e({code:V.CODE_NOT_FOUND});return}e(n.snippet)}).catch(n=>{console.log(n)})}},y=V;p(y,"QUERY_PARAM_NAME","query"),p(y,"CODE_NOT_FOUND","Not found.");var R=class{constructor(e){this.text=e}saveCode(e){}getCode(e){e({code:this.text})}};var B=class{saveCode(e){window.localStorage.setItem(B.LOCAL_STORAGE_KEY,e)}getCode(e){let t=window.localStorage.getItem(B.LOCAL_STORAGE_KEY);if(t==null){e({code:B.WELCOME_CODE});return}e({code:t})}},T=B;p(T,"LOCAL_STORAGE_KEY","code"),p(T,"WELCOME_CODE",`
...
`.trimStart();var ae=class{selectElement;onSelectHandler=null;constructor(){this.selectElement=document.querySelector(".js-examples__select")}registerOnSelectHandler(e){this.onSelectHandler=e}mount(){if(this.selectElement===null||this.selectElement===void 0)return;let e=document.querySelector(".dropdown__list"),t=this.selectElement.querySelector(".dropdown__button");if(e!==null&&t!==null){Y.forEach((g,f)=>{e.innerHTML+=ae.exampleElementListTemplate(g.name,f)});let c=t.querySelector("span");c.innerText=Y[0].name}let n=e.querySelectorAll(".dropdown__list-item");n.forEach(c=>{c.addEventListener("click",()=>{let g=c.innerText,f=Y.find(b=>b.name===g);this.onSelectHandler!==null&&f&&this.onSelectHandler(f)})});let o=this.selectElement.querySelector(".dropdown__button"),u=this.selectElement.querySelector(".dropdown__input_hidden"),l=document.querySelector(".dropdown__list");o.addEventListener("click",function(){l.classList.toggle("dropdown__list_visible"),this.classList.toggle("dropdown__button_active")}),n.forEach(function(c){c.addEventListener("click",function(g){n.forEach(function(m){m.classList.remove("dropdown__list-item_active")}),g.target.classList.add("dropdown__list-item_active");let b=o.querySelector("span");b.innerText=this.innerText,u.value=this.dataset.value??"",l.classList.remove("dropdown__list_visible")})}),document.addEventListener("click",function(c){c.target!==o&&!o.contains(c.target)&&(o.classList.remove("dropdown__button_active"),l.classList.remove("dropdown__list_visible"))}),document.addEventListener("keydown",function(c){(c.key==="Tab"||c.key==="Escape")&&(o.classList.remove("dropdown__button_active"),l.classList.remove("dropdown__list_visible"))})}},j=ae;p(j,"exampleElementListTemplate",function(e,t){let n="";return t===0&&(n="dropdown__list-item_active"),`
<li class="dropdown__list-item ${n}" data-value="${e}">${e}</li>
`});function we(a){let e=document.createElement("textarea");e.value=a,e.style.top="0",e.style.left="0",e.style.position="fixed",document.body.appendChild(e),e.focus(),e.select();try{let n=document.execCommand("copy")?"successful":"unsuccessful";console.log("Fallback: Copying text command was "+n)}catch(t){console.log("Fallback: Oops, unable to copy",t)}document.body.removeChild(e)}function le(a,e){return navigator.clipboard?navigator.clipboard.writeText(a).then(()=>{console.log("Async: Copying to clipboard was successful!"),e()},t=>{we(a),console.log("Async: Could not copy text: ",t,"fallback to old method")}):(we(a),Promise.resolve())}var K=class{constructor(e,t,n,o){this.code=e;this.buildArguments=t;this.runArguments=n;this.runConfiguration=o}toFormData(){let e=new FormData;return e.append("code",this.code),e.append("build-arguments",this.buildArguments.join(" ")),e.append("run-arguments",this.runArguments.join(" ")),e.append("run-configuration",this.runConfiguration.toString()),e}},w=class{static runCode(e){return fetch("/run",{method:"post",body:e.toFormData()}).then(t=>{if(t.status!=200)throw new Error("Can't run code");return t}).then(t=>t.json()).then(t=>t)}static runTest(e){return fetch("/run_test",{method:"post",body:e.toFormData()}).then(t=>{if(t.status!=200)throw new Error("Can't run test");return t}).then(t=>t.json()).then(t=>t)}static retrieveCgenCode(e){return fetch("/cgen",{method:"post",body:e.toFormData()}).then(t=>{if(t.status!=200)throw new Error("Can't compile and get C code");return t}).then(t=>t.json()).then(t=>t)}static formatCode(e){return fetch("/format",{method:"post",body:e.toFormData()}).then(t=>t.json()).then(t=>t)}static shareCode(e){return fetch("/share",{method:"post",body:e.toFormData()}).then(t=>{if(t.status!=200)throw new Error("Can't share code");return t}).then(t=>t.json()).then(t=>t)}static createBugUrl(e){return fetch("/create_bug_url",{method:"post",body:e.toFormData()}).then(t=>{if(t.status!=200)throw new Error("Can't create bug url");return t}).then(t=>t.json()).then(t=>t)}static getVlangVersion(){return fetch("/version",{method:"post"}).then(e=>{if(e.status!=200)throw new Error("Can't retrieve V version");return e}).then(e=>e.json()).then(e=>e)}};var W=class{constructor(e,t,n,o,u,l){this.terminal=o;let c={mode:l,lineNumbers:!0,matchBrackets:!0,extraKeys:{"Ctrl-Space":"autocomplete","Ctrl-/":"toggleComment"},readOnly:u,indentWithTabs:!0,indentUnit:4,autoCloseBrackets:!0,showHint:!0,lint:{async:!0,lintOnChange:!0,delay:20},toggleLineComment:{indent:!0,padding:" "},theme:"dark"};this.wrapperElement=t,this.textAreaElement=t.querySelector(`textarea.${e}`),this.editor=CodeMirror.fromTextArea(this.textAreaElement,c),this.repository=n,this.initFont()}wrapperElement;textAreaElement;repository;editor;initFont(){let e=window.localStorage.getItem(W.FONT_LOCAL_STORAGE_KEY);e!==null&&this.setEditorFontSize(e)}changeEditorFontSize(e){let t=document.getElementsByClassName("CodeMirror")[0],n=window.getComputedStyle(t,null).getPropertyValue("font-size");if(n){let o=parseInt(n)+e;t.style.fontSize=o+"px",window.localStorage.setItem(W.FONT_LOCAL_STORAGE_KEY,o.toString()),this.editor.refresh()}}setEditorFontSize(e){let t=document.getElementsByClassName("CodeMirror")[0];t.style.fontSize=e+"px",this.refresh()}setCode(e,t=!1){let n=this.editor.getCursor();this.editor.setValue(e),this.repository.saveCode(e),t&&this.editor.setCursor(n)}getCode(){return this.editor.getValue()}saveCode(){this.repository instanceof y&&(this.repository=new T),this.repository.saveCode(this.getCode())}getRunnableCodeSnippet(e){return new K(this.getCode(),e.buildArguments,e.runArguments,ye(e.configuration))}clear(){this.setCode("")}setTheme(e){this.editor.setOption("theme",e.name())}showCompletion(){this.editor.execCommand("autocomplete")}refresh(){this.editor.refresh()}hide(){let e=this.textAreaElement.parentElement;console.log(e),e!==void 0&&(e.style.display="none"),e.parentElement?.classList?.remove("two-editors")}show(){let e=this.textAreaElement.parentElement;console.log(e),e!==void 0&&(e.style.display="grid"),e.parentElement?.classList?.add("two-editors")}},H=W;p(H,"FONT_LOCAL_STORAGE_KEY","editor-font-size");var k=class{name(){return"dark"}};var U=class{name(){return"light"}};var N=class{themes=[new k,new U];currentTheme=null;onChange=[];queryParams;changeThemeButtons=null;predefinedTheme=null;fromQueryParam=!1;constructor(e,t=null){this.queryParams=e,this.predefinedTheme=t,this.changeThemeButtons=document.querySelectorAll(".js-change-theme__action")}registerOnChange(e){this.onChange.push(e)}loadTheme(){let e=this.queryParams.getURLParameter(N.QUERY_PARAM_NAME);if(e!=null){this.fromQueryParam=!0;let u=this.findTheme(e);this.turnTheme(u);return}let t=window.localStorage.getItem(N.LOCAL_STORAGE_KEY);if(t!=null){let u=this.findTheme(t);this.turnTheme(u);return}if(this.predefinedTheme!==null&&this.predefinedTheme!==void 0){this.turnTheme(this.predefinedTheme);return}let o=window.matchMedia("(prefers-color-scheme: dark)").matches?new k:new U;this.turnTheme(o)}findTheme(e){let t=this.themes.filter(o=>o.name()===e),n=t[0];return t.length==0&&(n=new k),n}turnTheme(e){this.currentTheme=e,this.onChange.forEach(n=>n(e)),this.changeThemeButtons!==null&&this.changeThemeButtons.forEach(n=>{let o=n.querySelector(".sun"),u=n.querySelector(".moon");o!==null&&u!==null&&(e.name()==="dark"?(o.style.display="block",u.style.display="none"):(o.style.display="none",u.style.display="block"))}),document.querySelector("html").setAttribute("data-theme",e.name()),this.fromQueryParam||window.localStorage.setItem(N.LOCAL_STORAGE_KEY,e.name()),this.fromQueryParam&&this.queryParams.updateURLParameter(N.QUERY_PARAM_NAME,e.name())}turnDarkTheme(){this.turnTheme(new k)}turnLightTheme(){this.turnTheme(new U)}toggleTheme(){this.currentTheme&&(this.currentTheme.name()==="light"?this.turnDarkTheme():this.turnLightTheme())}},P=N;p(P,"QUERY_PARAM_NAME","theme"),p(P,"LOCAL_STORAGE_KEY","theme");var J=class{element;onClose=null;onWrite=null;filters=[];constructor(e){this.element=e,this.attachResizeHandler(e)}registerCloseHandler(e){this.onClose=e}registerWriteHandler(e){this.onWrite=e}registerFilter(e){this.filters.push(e)}write(e){let t=e.split(`
`),n=this.getTerminalOutputElement(),u=t.filter(l=>this.filters.every(c=>c(l))).join(`
`);n.innerHTML+=u+`
`,this.onWrite!==null&&this.onWrite(e)}clear(){this.getTerminalOutputElement().innerHTML=""}mount(){let e=this.element.querySelector(".js-terminal__close-buttom");e==null||this.onClose===null||e.addEventListener("click",this.onClose)}getTerminalOutputElement(){return this.element.querySelector(".js-terminal__output")}attachResizeHandler(e){let t=e.querySelector(".header");if(!t)return;let n=!1;t.addEventListener("mousedown",()=>{n=!0,document.body.classList.add("dragging")}),t.addEventListener("touchstart",()=>{n=!0,document.body.classList.add("dragging")}),t.addEventListener("touchmove",o=>{n&&(e.style.height=`${document.body.clientHeight-o.touches[0].clientY+t.clientHeight/2}px`,o.preventDefault())}),document.addEventListener("mousemove",o=>{n&&(e.style.height=`${document.body.clientHeight-o.clientY+t.clientHeight/2}px`)}),document.addEventListener("mouseup",()=>{n=!1,document.body.classList.remove("dragging")}),document.addEventListener("touchend",()=>{n=!1,document.body.classList.remove("dragging")})}};var X=class{layerElement;constructor(){this.layerElement=document.querySelector(".js-tips-layer"),this.mount()}mount(){document.querySelector(".js-tips-layer__close").addEventListener("click",()=>{this.hide()}),document.addEventListener("keydown",t=>{this.isShown()&&t.key==="Escape"&&this.hide()})}isShown(){return this.layerElement.classList.contains("open")}show(){window.localStorage.getItem(X.DONT_SHOW_AGAIN_LOCAL_STORAGE_KEY)!=="true"&&(this.layerElement.classList.add("open"),window.localStorage.setItem(X.DONT_SHOW_AGAIN_LOCAL_STORAGE_KEY,"true"))}hide(){this.layerElement.classList.remove("open")}},F=X;p(F,"DONT_SHOW_AGAIN_LOCAL_STORAGE_KEY","no-more-tips");var ue="unsaved",Z=class{runAsTestConsumer=()=>!1;wrapperElement;queryParams;repository;editor;cgenEditor;themeManager;examplesManager;helpManager;runConfigurationManager;tipsManager;terminal;cgenMode=!1;constructor(e){this.wrapperElement=e,this.queryParams=new I(window.location.search),this.repository=G.selectRepository(this.queryParams);let t=e.querySelector(".js-terminal");if(t==null)throw new Error("Terminal not found, please check that terminal inside editor element");this.terminal=new J(t),this.editor=new H("main",e,this.repository,this.terminal,!1,"v"),this.cgenEditor=new H("cgen",e,new R(""),this.terminal,!0,"text/x-csrc"),this.cgenEditor.hide(),this.repository.getCode(n=>{if(n.code===y.CODE_NOT_FOUND){this.editor.setCode(be),this.terminal.write("Code for shared link not found.");return}if(n.runConfiguration!==void 0){let o=Ce(n.runConfiguration);this.runConfigurationManager.useConfiguration(o)}n.buildArguments!==void 0&&this.runConfigurationManager.setBuildArguments(n.buildArguments),n.runArguments!==void 0&&this.runConfigurationManager.setRunArguments(n.runArguments),this.editor.setCode(n.code)}),this.themeManager=new P(this.queryParams),this.themeManager.registerOnChange(n=>{this.editor.setTheme(n),this.cgenEditor.setTheme(n)}),this.themeManager.loadTheme(),this.examplesManager=new j,this.examplesManager.registerOnSelectHandler(n=>{if(this.editor.setCode(n.code),this.runConfigurationManager.configuration==="Cgen"){this.cgenEditor.clear(),this.cgenEditor.setCode("Rerun Cgen to see C code");return}this.runConfigurationManager.useConfiguration(n.runConfiguration)}),this.examplesManager.mount(),this.helpManager=new q(e),this.runConfigurationManager=new L(this.queryParams),this.runConfigurationManager.registerOnChange(()=>{}),this.runConfigurationManager.registerOnSelect(n=>{this.runConfigurationManager.toggleConfigurationsList(),n==="Cgen"&&this.cgenEditor.show(),this.run()}),this.runConfigurationManager.setupConfiguration(),this.tipsManager=new F,this.registerAction("close-cgen",()=>{this.cgenEditor.hide(),this.disableCgenMode()}),this.registerAction("create-bug",()=>{this.clearTerminal(),this.writeToTerminal("Creating bug report url..."),w.createBugUrl(this.editor.getRunnableCodeSnippet(this.runConfigurationManager)).then(o=>{if(o.error!=""){this.writeToTerminal("Error creating bug report url: "+o.error);return}this.writeToTerminal("Bug report url created, opening GitHub in new tab..."),le(o.link,()=>{this.writeToTerminal("Bug report url copied to clipboard")}).then(()=>{window.open(o.link,"_blank")})})}),this.terminal.registerCloseHandler(()=>{this.closeTerminal()}),this.terminal.registerWriteHandler(n=>{this.openTerminal()}),this.terminal.registerFilter(n=>!n.trim().startsWith("Failed command")),this.terminal.mount(),this.closeTerminal()}enableCgenMode(){this.tipsManager.show(),this.wrapperElement.querySelectorAll(".playground__editor").forEach(e=>{e.classList.add("with-tabs")}),this.cgenMode=!0}disableCgenMode(){this.wrapperElement.querySelectorAll(".playground__editor").forEach(e=>{e.classList.remove("with-tabs")}),this.removeEditorLinesHighlighting(),this.cgenMode=!1}registerRunAsTestConsumer(e){this.runAsTestConsumer=e}registerAction(e,t){let n=document.querySelectorAll(`.js-${e}__action`);if(n.length==0)throw new Error(`Can't find any action button with class js-${e}__action`);n.forEach(o=>{o.addEventListener("click",t)})}getRunnableCodeSnippet(){return this.editor.getRunnableCodeSnippet(this.runConfigurationManager)}run(){let e=this.runConfigurationManager.configuration;e==="Run"?this.runCode():e==="Test"?this.runTest():e==="Cgen"&&(this.enableCgenMode(),this.retrieveCgenCode())}runCode(){this.clearTerminal(),this.writeToTerminal("Running code...");let e=this.getRunnableCodeSnippet();w.runCode(e).then(t=>{if(t.error!=""){this.writeToTerminal(t.error),this.writeToTerminal("Can't run code. Please try again.");return}this.clearTerminal(),this.writeToTerminal(t.output)}).catch(t=>{console.log(t),this.writeToTerminal("Can't run code. Please try again.")})}runTest(){this.clearTerminal(),this.writeToTerminal("Running tests...");let e=this.getRunnableCodeSnippet();w.runTest(e).then(t=>{if(t.error!=""){this.writeToTerminal(t.error),this.writeToTerminal("Can't run tests. Please try again.");return}this.clearTerminal(),this.writeToTerminal(t.output)}).catch(t=>{console.log(t),this.writeToTerminal("Can't run tests. Please try again.")})}retrieveCgenCode(){this.clearTerminal(),this.writeToTerminal("Running retrieving of generated C code...");let e=this.getRunnableCodeSnippet();w.retrieveCgenCode(e).then(t=>{if(t.error!=""){this.clearTerminal(),this.writeToTerminal(t.error);return}let o=t.cgenCode.split(`
`),u=[],l={};for(let m=0;m<o.length-1;m++){let x=o[m],E=o[m+1];if(!E.startsWith("#line")){if(x.startsWith("#line")){if(E.length!=0){let A=x.split(" "),z=parseInt(A[1]);if(!A[2].includes("code.v"))continue;l[z]=E}continue}u.push(x)}}let c=u.join(`
`),g={};for(let m in l){let x=l[m],E=u.indexOf(x);E!=-1&&(g[m]=E)}let f=u.find(m=>m.startsWith("void main__main(void) {"))||"",b=u.indexOf(f);b==-1&&(b=0),console.log(g),window.localStorage.setItem("cgen-mapping",JSON.stringify(g)),this.clearTerminal(),this.cgenEditor.show(),this.cgenEditor.setCode(c),this.cgenEditor.editor.scrollIntoView({line:b,ch:0}),this.closeTerminal(),t.exitCode!=0&&(this.writeToTerminal(t.buildOutput),this.openTerminal())}).catch(t=>{console.log(t),this.writeToTerminal("Can't compile and get C code. Please try again.")})}formatCode(){this.clearTerminal();let e=this.getRunnableCodeSnippet();w.formatCode(e).then(t=>{if(t.error!=""){this.clearTerminal(),this.writeToTerminal(t.error);return}this.editor.setCode(t.output,!0)}).catch(t=>{console.log(t),this.writeToTerminal("Can't format code. Please try again.")})}shareCode(){this.clearTerminal();let e=this.getRunnableCodeSnippet();console.log(e),w.shareCode(e).then(t=>{if(t.error!=""){this.writeToTerminal("Can't share code. Please try again."),this.writeToTerminal(t.error);return}this.writeToTerminal("Code shared successfully!");let n=this.buildShareLink(t);this.writeToTerminal("Share link: "+n),le(n,()=>{this.writeToTerminal(`
Link copied to clipboard.`)})}).catch(t=>{console.log(t),this.writeToTerminal("Can't share code. Please try again.")})}buildShareLink(e){return`https://vosca.dev/p/${e.hash}`}changeTheme(){this.themeManager.toggleTheme()}setupShortcuts(){this.editor.editor.on("keypress",(e,t)=>{!e.state.completionActive&&t.key.length===1&&t.key.match(/[a-z0-9]/i)&&this.editor.showCompletion()}),this.editor.editor.on("mousedown",e=>{this.cgenMode&&setTimeout(()=>{this.removeEditorLinesHighlighting();let t=e.getCursor(),n=t.line+1,o=window.localStorage.getItem("cgen-mapping")??"{}",l=JSON.parse(o)[n];l!==void 0&&(this.cgenEditor.editor.scrollIntoView({line:l,ch:0}),console.log(l),this.cgenEditor.editor.addLineClass(l,"text","cgen-highlight"),window.localStorage.setItem("highlighted-c-line",l.toString()),this.editor.editor.addLineClass(t.line,"text","cgen-highlight"),window.localStorage.setItem("highlighted-v-line",t.line.toString()),this.editor.editor.focus())},100)}),document.addEventListener("keydown",e=>{this.repository instanceof y&&!e.ctrlKey&&!e.metaKey&&this.markCodeAsUnsaved();let n=e.ctrlKey&&e.key==="Enter",o=e.ctrlKey&&e.key==="r",u=e.shiftKey&&e.key==="Enter";n||o||u?(this.run(),e.preventDefault()):e.ctrlKey&&e.key==="l"?(this.formatCode(),e.preventDefault()):e.ctrlKey&&(e.key==="="||e.key==="+")?(this.editor.changeEditorFontSize(1),e.preventDefault()):e.ctrlKey&&e.key==="-"?(this.editor.changeEditorFontSize(-1),e.preventDefault()):e.ctrlKey&&e.key==="i"?(this.helpManager.toggleHelp(),e.preventDefault()):(e.ctrlKey||e.metaKey)&&e.key==="s"?(this.editor.saveCode(),e.preventDefault()):e.key==="Escape"?(this.helpManager.closeHelp(),e.preventDefault()):this.editor.saveCode()})}removeEditorLinesHighlighting(){let e=window.localStorage.getItem("highlighted-c-line");e!=null&&this.cgenEditor.editor.removeLineClass(parseInt(e),"text","cgen-highlight");let t=window.localStorage.getItem("highlighted-v-line");t!=null&&this.editor.editor.removeLineClass(parseInt(t),"text","cgen-highlight")}askLoadUnsavedCode(){let e=this.repository instanceof y,t=window.localStorage.getItem(ue)!=null;window.localStorage.removeItem(ue),e&&t&&confirm("You load the code from the link, but you have previously unsaved changes. Do you want to load it instead of code from link?")&&(this.queryParams.updateURLParameter(y.QUERY_PARAM_NAME,null),window.location.reload())}clearTerminal(){this.terminal.clear()}writeToTerminal(e){this.terminal.write(e)}openTerminal(){this.wrapperElement.classList.remove("closed-terminal")}closeTerminal(){this.wrapperElement.classList.add("closed-terminal"),this.editor.refresh()}markCodeAsUnsaved(){window.localStorage.setItem(ue,"")}};w.getVlangVersion().then(a=>{let e=document.querySelector(".js-version-info");e.innerHTML=a.version});var Re=document.querySelector(".js-playground"),v=new Z(Re);v.registerAction("run",()=>{v.run()});v.registerAction("format",()=>{v.formatCode()});v.registerAction("share",()=>{v.shareCode()});v.registerAction("change-theme",()=>{v.changeTheme()});v.registerRunAsTestConsumer(()=>document.querySelector(".js-run__action").getAttribute("data-type")==="Test");v.setupShortcuts();v.askLoadUnsavedCode();window.onload=()=>{let a=document.querySelector("html");a.style.opacity="1"};})();
