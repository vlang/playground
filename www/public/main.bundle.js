...
`;var G=(t=>(t.Run="Run",t.Test="Test",t))(G||{});function K(s){switch(s){case"Run":return"Run";case"Test":return"Test";default:throw new Error(`Unknown run configuration type: ${s}`)}}var x=class{queryParams;currentConfiguration="Run";fromQueryParam=!1;runButton=document.querySelector(".js-playground__action-run");runButtonLabel=document.querySelector(".js-playground__action-run .label");openRunButton=document.querySelector(".js-open-run-select");configurationsList=document.querySelector(".js-run-configurations-list");configurations=document.querySelectorAll(".js-configuration");onChange=()=>{};onSelect=()=>{};constructor(e){this.queryParams=e,this.mount()}registerOnChange(e){this.onChange=e}registerOnSelect(e){this.onSelect=e}toggleConfigurationsList(){this.configurationsList.classList.toggle("hidden")}setupConfiguration(){let e=this.queryParams.getURLParameter(x.QUERY_PARAM_NAME);if(e!=null){this.fromQueryParam=!0,this.useConfiguration(K(e));return}let t=window.localStorage.getItem(x.LOCAL_STORAGE_KEY);if(t!=null){this.useConfiguration(K(t));return}this.useConfiguration("Run")}useConfiguration(e){this.currentConfiguration=e,this.onChange(e);let t=G[e];this.runButton.setAttribute("data-type",t),this.runButtonLabel.textContent=t,this.fromQueryParam||window.localStorage.setItem(x.LOCAL_STORAGE_KEY,t),this.fromQueryParam&&this.queryParams.updateURLParameter(x.QUERY_PARAM_NAME,t),this.setIconForV(e)}setIconForV(e){let t=ne;e!="Run"&&(t=ie),document.querySelector(".title-v-part").innerHTML=t}mount(){this.openRunButton.addEventListener("click",()=>{this.toggleConfigurationsList()}),this.configurations.forEach(e=>{e.addEventListener("click",()=>{let t=e.getAttribute("data-type")??"Run",n=K(t);this.useConfiguration(n),this.onSelect(n)})})}},L=x;h(L,"QUERY_PARAM_NAME","runConfiguration"),h(L,"LOCAL_STORAGE_KEY","run-configuration");var N=[{name:"Hello, Playground!",code:C.WELCOME_CODE,runConfiguration:"Run"},{name:"String interpolation",code:`
...
`.trimStart();var F=class{wrapperElement;repository;editor;terminal;constructor(e,t){let n={mode:"v",lineNumbers:!0,matchBrackets:!0,extraKeys:{"Ctrl-Space":"autocomplete","Ctrl-/":"toggleComment"},indentWithTabs:!0,indentUnit:4,autoCloseBrackets:!0,showHint:!0,lint:{async:!0,lintOnChange:!0,delay:20},toggleLineComment:{indent:!0,padding:" "},theme:"dark"};this.wrapperElement=e;let a=e.querySelector("textarea");this.editor=CodeMirror.fromTextArea(a,n),this.repository=t,this.repository.getCode(l=>{if(l===p.CODE_NOT_FOUND){this.setCode(oe),this.terminal.write("Code for shared link not found.");return}this.setCode(l)});let u=e.querySelector(".js-terminal");if(u==null)throw new Error("Terminal not found, please check that terminal inside editor element");this.terminal=new B(u),this.terminal.registerCloseHandler(()=>{this.closeTerminal(),this.editor.refresh()}),this.terminal.registerWriteHandler(l=>{this.openTerminal()}),this.terminal.registerFilter(l=>!l.trim().startsWith("Failed command")),this.terminal.mount(),this.initFont()}initFont(){let e=window.localStorage.getItem(F.FONT_LOCAL_STORAGE_KEY);e!==null&&this.setEditorFontSize(e)}changeEditorFontSize(e){let t=document.getElementsByClassName("CodeMirror")[0],n=window.getComputedStyle(t,null).getPropertyValue("font-size");if(n){let a=parseInt(n)+e;t.style.fontSize=a+"px",window.localStorage.setItem(F.FONT_LOCAL_STORAGE_KEY,a.toString()),this.editor.refresh()}}setEditorFontSize(e){let t=document.getElementsByClassName("CodeMirror")[0];t.style.fontSize=e+"px",this.refresh()}setCode(e,t=!1){let n=this.editor.getCursor();this.editor.setValue(e),this.repository.saveCode(e),t&&this.editor.setCursor(n)}getCode(){return this.editor.getValue()}saveCode(){this.repository instanceof p&&(this.repository=new C),this.repository.saveCode(this.getCode())}openTerminal(){this.wrapperElement.classList.remove("closed-terminal")}closeTerminal(){this.wrapperElement.classList.add("closed-terminal")}setTheme(e){this.editor.setOption("theme",e.name())}showCompletion(){this.editor.execCommand("autocomplete")}refresh(){this.editor.refresh()}},H=F;h(H,"FONT_LOCAL_STORAGE_KEY","editor-font-size");var v=class{name(){return"dark"}};var A=class{name(){return"light"}};var re=`<span class="icon">
