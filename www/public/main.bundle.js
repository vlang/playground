...
`.trimStart();var ae=class{selectElement;onSelectHandler=null;constructor(){this.selectElement=document.querySelector(".js-examples__select")}registerOnSelectHandler(e){this.onSelectHandler=e}mount(){if(this.selectElement===null||this.selectElement===void 0)return;let e=document.querySelector(".dropdown__list"),t=this.selectElement.querySelector(".dropdown__button");if(e!==null&&t!==null){Q.forEach((g,y)=>{e.innerHTML+=ae.exampleElementListTemplate(g.name,y)});let c=t.querySelector("span");c.innerText=Q[0].name}let n=e.querySelectorAll(".dropdown__list-item");n.forEach(c=>{c.addEventListener("click",()=>{let g=c.innerText,y=Q.find(C=>C.name===g);this.onSelectHandler!==null&&y&&this.onSelectHandler(y)})});let r=this.selectElement.querySelector(".dropdown__button"),u=this.selectElement.querySelector(".dropdown__input_hidden"),a=document.querySelector(".dropdown__list");r.addEventListener("click",function(){a.classList.toggle("dropdown__list_visible"),this.classList.toggle("dropdown__button_active")}),n.forEach(function(c){c.addEventListener("click",function(g){n.forEach(function(m){m.classList.remove("dropdown__list-item_active")}),g.target.classList.add("dropdown__list-item_active");let C=r.querySelector("span");C.innerText=this.innerText,u.value=this.dataset.value??"",a.classList.remove("dropdown__list_visible")})}),document.addEventListener("click",function(c){c.target!==r&&!r.contains(c.target)&&(r.classList.remove("dropdown__button_active"),a.classList.remove("dropdown__list_visible"))}),document.addEventListener("keydown",function(c){(c.key==="Tab"||c.key==="Escape")&&(r.classList.remove("dropdown__button_active"),a.classList.remove("dropdown__list_visible"))})}},q=ae;p(q,"exampleElementListTemplate",function(e,t){let n="";return t===0&&(n="dropdown__list-item_active"),`
