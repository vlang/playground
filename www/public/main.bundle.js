...
`),u=[],l={};for(let m=0;m<o.length-1;m++){let x=o[m],E=o[m+1];if(!E.startsWith("#line")){if(x.startsWith("#line")){if(E.length!=0){let N=x.split(" "),z=parseInt(N[1]);l[z]=E}continue}u.push(x)}}let c=u.join(`
