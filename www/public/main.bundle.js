"use strict";(()=>{var le=Object.defineProperty;var ue=(r,e,t)=>e in r?le(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var h=(r,e,t)=>(ue(r,typeof e!="symbol"?e+"":e,t),t);var U=class{constructor(e,t,n,l,u){this.indentation=e;this.column=t;this.type=n;this.align=l;this.prev=u}insideString=!1;stringQuote=null;expectedImportName=!1;knownImports=new Set},N=new Set(["as","asm","assert","atomic","break","const","continue","defer","else","enum","fn","for","go","goto","if","import","in","interface","is","isreftype","lock","match","module","mut","none","or","pub","return","rlock","select","shared","sizeof","static","struct","spawn","type","typeof","union","unsafe","volatile","__offsetof"]),Q=new Set(["sql","chan","thread"]),$=new Set(["true","false","nil","print","println","exit","panic","error","dump"]),D=new Set(["bool","string","i8","i16","int","i64","i128","u8","u16","u32","u64","u128","rune","f32","f64","isize","usize","voidptr","any"]);CodeMirror.defineMode("v",r=>{let e=r.indentUnit??0,t=/[+\-*&^%:=<>!|\/]/,n=null;function l(o){return o.eatWhile(/[\w$_\xa1-\uffff]/),o.current()}function u(o,i){let s=o.next();if(s===null)return null;if(i.context.insideString&&s==="}")return o.eat("}"),i.tokenize=m(i.context.stringQuote),"end-interpolation";if(s==='"'||s==="'"||s==="`")return i.tokenize=m(s),i.tokenize(o,i);if(/[\d.]/.test(s)){if(s==="."){if(!o.match(/^[0-9_]+([eE][\-+]?[0-9_]+)?/))return"operator"}else s==="0"?o.match(/^[xX][0-9a-fA-F_]+/)||o.match(/^0[0-7_]+/):o.match(/^[0-9_]*\.?[0-9_]*([eE][\-+]?[0-9_]+)?/);return"number"}if(/[\[\]{}(),;:.]/.test(s))return n=s,null;if(s==="/"){if(o.eat("*"))return i.tokenize=b,b(o,i);if(o.eat("/"))return o.skipToEnd(),"comment"}if(t.test(s))return o.eatWhile(t),"operator";if(s==="@")return l(o),"at-identifier";if(s==="$"){let w=l(o).slice(1);return N.has(w)?"keyword":"compile-time-identifier"}let d=l(o);if(d==="import"&&(i.context.expectedImportName=!0),N.has(d)||Q.has(d))return"keyword";if($.has(d))return"atom";if(D.has(d))return"builtin";if(d[0].toUpperCase()===d[0])return"type";let f=o.peek();if(f==="("||f==="<")return"function";if(f==="["){o.next();let w=o.next();if(o.backUp(2),w!=null&&w.match(/[A-Z]/i))return"function"}return i.context.expectedImportName&&o.peek()!="."?(i.context.expectedImportName=!1,i.context.knownImports===void 0&&(i.context.knownImports=new Set),i.context.knownImports.add(d),"import-name"):i.context.knownImports.has(d)&&o.peek()=="."?"import-name":"variable"}function a(o,i){return o.match("}")?(i.tokenize=m(i.context.stringQuote),"end-interpolation"):(i.tokenize=u,i.tokenize(o,i))}function c(o,i){let s=o.next();if(s===" ")return i.tokenize=m(i.context.stringQuote),i.tokenize(o,i);if(s===".")return"operator";let d=l(o);if(d[0].toLowerCase()===d[0].toUpperCase())return i.tokenize=m(i.context.stringQuote),i.tokenize(o,i);let f=o.next();return o.backUp(1),f==="."?i.tokenize=c:i.tokenize=m(i.context.stringQuote),"variable"}function g(o,i){let s=o.next();return s==="$"&&o.eat("{")?(i.tokenize=a,"start-interpolation"):s==="$"?(i.tokenize=c,"start-interpolation"):"string"}function m(o){return function(i,s){s.context.insideString=!0,s.context.stringQuote=o;let d="",f=!1,w=!1;for(;(d=i.next())!=null;){if(d===o&&!f){w=!0;break}if(d==="$"&&!f&&i.eat("{"))return s.tokenize=g,i.backUp(2),"string";if(d==="$"&&!f)return s.tokenize=g,i.backUp(1),"string";f=!f&&d==="\\"}return(w||f)&&(s.tokenize=u),s.context.insideString=!1,s.context.stringQuote=null,"string"}}function b(o,i){let s=!1,d;for(;d=o.next();){if(d==="/"&&s){i.tokenize=u;break}s=d==="*"}return"comment"}function j(o,i,s){return o.context=new U(o.indention,i,s,null,o.context)}function ee(o){if(!o.context.prev)return;let i=o.context.type;return(i===")"||i==="]"||i==="}")&&(o.indention=o.context.indentation),o.context=o.context.prev,o.context}return{startState:function(){return{tokenize:null,context:new U(0,0,"top",!1),indention:0,startOfLine:!0}},token:function(o,i){let s=i.context;if(o.sol()&&(s.align==null&&(s.align=!1),i.indention=o.indentation(),i.startOfLine=!0),o.eatSpace())return null;n=null;let d=(i.tokenize||u)(o,i);return d==="comment"||(s.align==null&&(s.align=!0),n==="{"?j(i,o.column(),"}"):n==="["?j(i,o.column(),"]"):n==="("?j(i,o.column(),")"):(n==="}"&&s.type==="}"||n===s.type)&&ee(i),i.startOfLine=!1),d},indent:function(o,i){if(o.tokenize!==u&&o.tokenize!=null||o.context.type=="top")return 0;let s=o.context,f=i.charAt(0)===s.type;return s.align?s.column+(f?0:1):s.indentation+(f?0:e)},electricChars:"{}):",closeBrackets:"()[]{}''\"\"``",fold:"brace",blockCommentStart:"/*",blockCommentEnd:"*/",lineComment:"//"}});CodeMirror.defineMIME("text/x-v","v");var Y=CodeMirror.Pos,ce=["arrays","benchmark","bitfield","cli","clipboard","compress","context","crypto","darwin","datatypes","dl","dlmalloc","encoding","eventbus","flag","fontstash","gg","gx","hash","io","js","json","log","math","mssql","mysql","net","orm","os","pg","picoev","picohttpparser","rand","readline","regex","runtime","semver","sokol","sqlite","stbi","strconv","strings","sync","szip","term","time","toml","v","vweb","x"];function de(r){let e=[],t=r.getCursor(),n=r.getTokenAt(t),l=new Set;for(let g=0;g<Math.min(r.lineCount(),10);g++){let m=r.getLineTokens(g).filter(b=>b.type!=null);m.length>0&&m[0].string==="import"&&l.add(m[m.length-1].string)}let u=r.getLineTokens(t.line);u.length>0&&u[0].string==="import"&&e.push(u[0]);let a=n.string.length,c=r.getTokenAt(Y(t.line,t.ch-a));return n.string==="."&&e.push(n),c.string==="."&&e.push(c),/\b(?:string|comment)\b/.test(n.type??"")?null:(/^[\w$_]*$/.test(n.string)?n.end>t.ch&&(n.end=t.ch,n.string=n.string.slice(0,t.ch-n.start)):n={start:t.ch,end:t.ch,string:"",state:n.state,type:n.string==="."?"property":null},{list:he(n,l,e),from:Y(t.line,n.start),to:Y(t.line,n.end)})}function he(r,e,t){let n=[],l=r.string;function u(a){let c=a.text;if(c.indexOf(l)===-1)return;n.find(m=>m.text===c)||n.push(a)}if(t&&t.length){let a=t.pop();if(a!==void 0){if(a.type==="keyword"&&a.string==="import")return ce.forEach(c=>{u({text:c,displayText:c,className:"completion-module"})}),n;if(a.string===".")return[]}}return e.forEach(a=>{u({text:a,displayText:a,className:"completion-module"})}),N.forEach(a=>{u({text:a+" ",displayText:a,className:"completion-keyword"})}),Q.forEach(a=>{u({text:a+" ",displayText:a,className:"completion-keyword"})}),$.forEach(a=>{u({text:a,displayText:a,className:"completion-atom"})}),D.forEach(a=>{u({text:a,displayText:a,className:"completion-type"})}),n}var me=r=>de(r);CodeMirror.registerHelper("hint","v",me);var p=class{hash;constructor(e){this.hash=e}saveCode(e){}getCode(e){return this.getSharedCode(e)}getSharedCode(e){let t=new FormData;t.append("hash",this.hash),fetch("/query",{method:"post",body:t}).then(n=>n.text()).then(n=>{e(n)}).catch(n=>{console.log(n)})}};h(p,"QUERY_PARAM_NAME","query"),h(p,"CODE_NOT_FOUND","Not found.");var M=class{constructor(e){this.text=e}saveCode(e){}getCode(e){e(this.text)}};var A=class{saveCode(e){window.localStorage.setItem(A.LOCAL_STORAGE_KEY,e)}getCode(e){let t=window.localStorage.getItem(A.LOCAL_STORAGE_KEY);if(t==null){e(A.WELCOME_CODE);return}e(t)}},C=A;h(C,"LOCAL_STORAGE_KEY","code"),h(C,"WELCOME_CODE",`
...
// Enjoy!
`.trimStart());var E=class{constructor(e){this.text=e;this.decodedCode=atob(e)}decodedCode;saveCode(e){}getCode(e){e(this.decodedCode)}};h(E,"QUERY_PARAM_NAME","base64");var L=class{constructor(e){this.id=e}saveCode(e){}getCode(e){fetch("https://api.github.com/gists/"+this.id,{method:"get",headers:{"Content-Type":"application/json"}}).then(t=>t.json()).then(t=>{let n=t.files,l=Object.keys(n)[0],a=n[l].raw_url;fetch(a,{method:"get",headers:{"Content-Type":"text/plain"}}).then(c=>c.text()).then(c=>{e(c)}).catch(c=>{console.log(c)})}).catch(t=>{console.log(t)})}};h(L,"QUERY_PARAM_NAME","gist");var B=class{static selectRepository(e,t){if(t!==void 0&&t.codeHash!==null&&t.codeHash!==void 0)return new p(t.codeHash);if(t!==void 0&&t.code!==null&&t.code!==void 0)return new M(t.code);if(t!==void 0&&t.embed!==null&&t.embed!==void 0&&t.embed)return new M("");let n=new C,l=e.getURLParameter(p.QUERY_PARAM_NAME);if(l!=null)return new p(l);let u=e.getURLParameter(E.QUERY_PARAM_NAME);if(u!=null)return new E(u);let a=e.getURLParameter(L.QUERY_PARAM_NAME);return a!=null?new L(a):n}};var _=class{params;constructor(e){this.params=new URLSearchParams(e)}updateURLParameter(e,t){let n=_.updateURLParameter(window.location.href,e,t);window.history.replaceState({},"",n)}getURLParameter(e){return this.params.get(e)}static updateURLParameter(e,t,n){let l=new URL(e);return n?l.searchParams.set(t,n):l.searchParams.delete(t),l.toString()}};var K=class{containingElement;element;helpOverlay;showHelpButton;closeHelpButton;constructor(e){this.containingElement=e,this.element=e.getElementsByClassName("js-help-wrapper")[0],!(this.element===null||this.element===void 0)&&(this.helpOverlay=this.element.querySelector(".js-help-overlay"),this.showHelpButton=this.element.querySelector(".js-show-help"),this.closeHelpButton=this.element.querySelector(".js-close-help"),this.mount())}mount(){this.showHelpButton!==void 0&&this.showHelpButton.addEventListener("click",()=>{this.toggleHelp()}),this.helpOverlay!==void 0&&this.helpOverlay.addEventListener("click",()=>{this.toggleHelp()}),this.closeHelpButton!==void 0&&this.closeHelpButton.addEventListener("click",()=>{this.toggleHelp()}),K.isMac||document.querySelectorAll(".js-shortcut kbd.ctrl").forEach(function(t){t.innerText="Ctrl"})}closeHelp(){this.helpOverlay.classList.contains("opened")&&this.toggleHelp()}toggleHelp(){this.containingElement.getElementsByClassName("js-help")[0].classList.toggle("opened"),this.helpOverlay.classList.toggle("opened")}},H=K;h(H,"isMac",navigator.platform.toUpperCase().indexOf("MAC")>=0);function te(r){let e=document.createElement("textarea");e.value=r,e.style.top="0",e.style.left="0",e.style.position="fixed",document.body.appendChild(e),e.focus(),e.select();try{let n=document.execCommand("copy")?"successful":"unsuccessful";console.log("Fallback: Copying text command was "+n)}catch(t){console.log("Fallback: Oops, unable to copy",t)}document.body.removeChild(e)}function ne(r,e){if(!navigator.clipboard){te(r);return}navigator.clipboard.writeText(r).then(function(){console.log("Async: Copying to clipboard was successful!"),e()},function(t){te(r),console.log("Async: Could not copy text: ",t,"fallback to old method")})}var F=class{element;onClose=null;onWrite=null;filters=[];constructor(e){this.element=e,this.attachResizeHandler(e)}registerCloseHandler(e){this.onClose=e}registerWriteHandler(e){this.onWrite=e}registerFilter(e){this.filters.push(e)}write(e){let t=e.split(`
...
`;var W=(t=>(t.Run="Run",t.Test="Test",t))(W||{});function G(r){switch(r){case"Run":return"Run";case"Test":return"Test";default:throw new Error(`Unknown run configuration type: ${r}`)}}var S=class{queryParams;currentConfiguration="Run";fromQueryParam=!1;runButton=document.querySelector(".js-playground__action-run");runButtonLabel=document.querySelector(".js-playground__action-run .label");openRunButton=document.querySelector(".js-open-run-select");configurationsList=document.querySelector(".js-run-configurations-list");configurations=document.querySelectorAll(".js-configuration");onChange=()=>{};onSelect=()=>{};constructor(e){this.queryParams=e,this.mount()}registerOnChange(e){this.onChange=e}registerOnSelect(e){this.onSelect=e}toggleConfigurationsList(){this.configurationsList.classList.toggle("hidden")}setupConfiguration(){let e=this.queryParams.getURLParameter(S.QUERY_PARAM_NAME);if(e!=null){this.fromQueryParam=!0,this.useConfiguration(G(e));return}let t=window.localStorage.getItem(S.LOCAL_STORAGE_KEY);if(t!=null){this.useConfiguration(G(t));return}this.useConfiguration("Run")}useConfiguration(e){this.currentConfiguration=e,this.onChange(e);let t=W[e];this.runButton.setAttribute("data-type",t),this.runButtonLabel.textContent=t,this.fromQueryParam||window.localStorage.setItem(S.LOCAL_STORAGE_KEY,t),this.fromQueryParam&&this.queryParams.updateURLParameter(S.QUERY_PARAM_NAME,t),this.setIconForV(e)}setIconForV(e){let t=oe;e!="Run"&&(t=ie),document.querySelector(".title-v-part").innerHTML=t}mount(){this.openRunButton.addEventListener("click",()=>{this.toggleConfigurationsList()}),this.configurations.forEach(e=>{e.addEventListener("click",()=>{let t=e.getAttribute("data-type")??"Run",n=G(t);this.useConfiguration(n),this.onSelect(n)})})}},x=S;h(x,"QUERY_PARAM_NAME","runConfiguration"),h(x,"LOCAL_STORAGE_KEY","run-configuration");var q=[{name:"Hello, Playground!",code:C.WELCOME_CODE,runConfiguration:"Run"},{name:"String interpolation",code:`
...
`,runConfiguration:"Test"}].map(r=>(r.code=r.code.trim().replace(/^ {4}/gm,"	")+`
`,r)),re=`
// Oops, the shared link is broken.
// Please recheck the link and try again.
println('Hello, link 404!')
`.trimStart();var z=class{wrapperElement;repository;editor;terminal;constructor(e,t){let n={mode:"v",lineNumbers:!0,matchBrackets:!0,extraKeys:{"Ctrl-Space":"autocomplete","Ctrl-/":"toggleComment"},indentWithTabs:!0,indentUnit:4,autoCloseBrackets:!0,showHint:!0,lint:{async:!0,lintOnChange:!0,delay:20},toggleLineComment:{indent:!0,padding:" "},theme:"dark"};this.wrapperElement=e;let l=e.querySelector("textarea");this.editor=CodeMirror.fromTextArea(l,n),this.repository=t,this.repository.getCode(a=>{if(a===p.CODE_NOT_FOUND){this.setCode(re),this.terminal.write("Code for shared link not found.");return}this.setCode(a)});let u=e.querySelector(".js-terminal");if(u==null)throw new Error("Terminal not found, please check that terminal inside editor element");this.terminal=new F(u),this.terminal.registerCloseHandler(()=>{this.closeTerminal(),this.editor.refresh()}),this.terminal.registerWriteHandler(a=>{this.openTerminal()}),this.terminal.registerFilter(a=>!a.trim().startsWith("Failed command")),this.terminal.mount(),this.initFont()}initFont(){let e=window.localStorage.getItem(z.FONT_LOCAL_STORAGE_KEY);e!==null&&this.setEditorFontSize(e)}changeEditorFontSize(e){let t=document.getElementsByClassName("CodeMirror")[0],n=window.getComputedStyle(t,null).getPropertyValue("font-size");if(n){let l=parseInt(n)+e;t.style.fontSize=l+"px",window.localStorage.setItem(z.FONT_LOCAL_STORAGE_KEY,l.toString()),this.editor.refresh()}}setEditorFontSize(e){let t=document.getElementsByClassName("CodeMirror")[0];t.style.fontSize=e+"px",this.refresh()}setCode(e,t=!1){let n=this.editor.getCursor();this.editor.setValue(e),this.repository.saveCode(e),t&&this.editor.setCursor(n)}getCode(){return this.editor.getValue()}saveCode(){this.repository instanceof p&&(this.repository=new C),this.repository.saveCode(this.getCode())}openTerminal(){this.wrapperElement.classList.remove("closed-terminal")}closeTerminal(){this.wrapperElement.classList.add("closed-terminal")}setTheme(e){this.editor.setOption("theme",e.name())}showCompletion(){this.editor.execCommand("autocomplete")}refresh(){this.editor.refresh()}},O=z;h(O,"FONT_LOCAL_STORAGE_KEY","editor-font-size");var v=class{name(){return"dark"}};var P=class{name(){return"light"}};var se=`<span class="icon">
...
`;var R=class{themes=[new v,new P];currentTheme=null;onChange=[];queryParams;changeThemeButton=null;predefinedTheme=null;fromQueryParam=!1;constructor(e,t=null){this.queryParams=e,this.predefinedTheme=t,this.changeThemeButton=document.querySelector(".js-playground__action-change-theme")}registerOnChange(e){this.onChange.push(e)}loadTheme(){let e=this.queryParams.getURLParameter(R.QUERY_PARAM_NAME);if(e!=null){this.fromQueryParam=!0;let n=this.findTheme(e);this.turnTheme(n);return}let t=window.localStorage.getItem(R.LOCAL_STORAGE_KEY);if(t!=null){let n=this.findTheme(t);this.turnTheme(n);return}if(this.predefinedTheme!==null&&this.predefinedTheme!==void 0){this.turnTheme(this.predefinedTheme);return}this.turnTheme(new v)}findTheme(e){let t=this.themes.filter(l=>l.name()===e),n=t[0];return t.length==0&&(n=new v),n}turnTheme(e){this.currentTheme=e,this.onChange.forEach(l=>l(e));let t=se;e.name()==="dark"&&(t=ae),this.changeThemeButton!==null&&(this.changeThemeButton.innerHTML=t),document.querySelector("html").setAttribute("data-theme",e.name()),this.fromQueryParam||window.localStorage.setItem(R.LOCAL_STORAGE_KEY,e.name()),this.fromQueryParam&&this.queryParams.updateURLParameter(R.QUERY_PARAM_NAME,e.name())}turnDarkTheme(){this.turnTheme(new v)}turnLightTheme(){this.turnTheme(new P)}toggleTheme(){this.currentTheme&&(this.currentTheme.name()==="light"?this.turnDarkTheme():this.turnLightTheme())}},k=R;h(k,"QUERY_PARAM_NAME","theme"),h(k,"LOCAL_STORAGE_KEY","theme");var Z=class{selectElement;onSelectHandler=null;constructor(){this.selectElement=document.querySelector(".js-examples__select")}registerOnSelectHandler(e){this.onSelectHandler=e}mount(){if(this.selectElement===null||this.selectElement===void 0)return;let e=this.selectElement.querySelector(".dropdown__list"),t=this.selectElement.querySelector(".dropdown__button");e!==null&&t!==null&&(q.forEach(function(c,g){e.innerHTML+=Z.exampleElementListTemplate(c.name,g)}),t.innerHTML=q[0].name);let n=this.selectElement.querySelectorAll(".dropdown__list-item");n.forEach(c=>{c.addEventListener("click",()=>{let g=c.innerText,m=q.find(b=>b.name===g);this.onSelectHandler!==null&&m&&this.onSelectHandler(m)})});let l=this.selectElement.querySelector(".dropdown__button"),u=this.selectElement.querySelector(".dropdown__list"),a=this.selectElement.querySelector(".dropdown__input_hidden");l.addEventListener("click",function(){u.classList.toggle("dropdown__list_visible"),this.classList.toggle("dropdown__button_active")}),n.forEach(function(c){c.addEventListener("click",function(g){n.forEach(function(b){b.classList.remove("dropdown__list-item_active")}),g.target.classList.add("dropdown__list-item_active"),l.innerText=this.innerText,a.value=this.dataset.value??"",u.classList.remove("dropdown__list_visible")})}),document.addEventListener("click",function(c){c.target!==l&&(l.classList.remove("dropdown__button_active"),u.classList.remove("dropdown__list_visible"))}),document.addEventListener("keydown",function(c){(c.key==="Tab"||c.key==="Escape")&&(l.classList.remove("dropdown__button_active"),u.classList.remove("dropdown__list_visible"))})}},I=Z;h(I,"exampleElementListTemplate",function(e,t){let n="";return t===0&&(n="dropdown__list-item_active"),`
<li class="dropdown__list-item ${n}" data-value="${e}">${e}</li>
`});var J=class{constructor(e){this.hash=e}},T=class{static runCode(e){let t=new FormData;return t.append("code",e),fetch("/run",{method:"post",body:t}).then(n=>{if(n.status!=200)throw new Error("Can't run code");return n}).then(n=>n.json()).then(n=>JSON.parse(n))}static runTest(e){let t=new FormData;return t.append("code",e),fetch("/run_test",{method:"post",body:t}).then(n=>{if(n.status!=200)throw new Error("Can't run test");return n}).then(n=>n.json()).then(n=>JSON.parse(n))}static formatCode(e){let t=new FormData;return t.append("code",e),fetch("/format",{method:"post",body:t}).then(n=>n.json()).then(n=>JSON.parse(n))}static shareCode(e){let t=new FormData;return t.append("code",e),fetch("/share",{method:"post",body:t}).then(n=>{if(n.status!=200)throw new Error("Can't share code");return n.text()}).then(n=>new J(n))}};var X="unsaved",V=class{runAsTestConsumer=()=>!1;queryParams;repository;editor;themeManager;examplesManager;helpManager;runConfigurationManager;constructor(e){this.queryParams=new _(window.location.search),this.repository=B.selectRepository(this.queryParams),this.editor=new O(e,this.repository),this.themeManager=new k(this.queryParams),this.themeManager.registerOnChange(t=>{this.editor.setTheme(t)}),this.themeManager.loadTheme(),this.examplesManager=new I,this.examplesManager.registerOnSelectHandler(t=>{this.editor.setCode(t.code),this.runConfigurationManager.useConfiguration(t.runConfiguration)}),this.examplesManager.mount(),this.helpManager=new H(e),this.runConfigurationManager=new x(this.queryParams),this.runConfigurationManager.registerOnChange(()=>{}),this.runConfigurationManager.registerOnSelect(()=>{this.runConfigurationManager.toggleConfigurationsList(),this.run()}),this.runConfigurationManager.setupConfiguration()}registerRunAsTestConsumer(e){this.runAsTestConsumer=e}registerAction(e,t){let n=document.getElementsByClassName(`js-playground__action-${e}`)[0];if(n===void 0)throw new Error(`Can't find action button with class js-playground__action-${e}`);n.addEventListener("click",t)}run(){if(this.runAsTestConsumer()){this.runTest();return}this.runCode()}runCode(){this.clearTerminal(),this.writeToTerminal("Running code...");let e=this.editor.getCode();T.runCode(e).then(t=>{this.clearTerminal(),this.writeToTerminal(t.output)}).catch(t=>{console.log(t),this.writeToTerminal("Can't run code. Please try again.")})}runTest(){this.clearTerminal(),this.writeToTerminal("Running tests...");let e=this.editor.getCode();T.runTest(e).then(t=>{this.clearTerminal(),this.writeToTerminal(t.output)}).catch(t=>{console.log(t),this.writeToTerminal("Can't run tests. Please try again.")})}formatCode(){this.clearTerminal(),this.writeToTerminal("Formatting code...");let e=this.editor.getCode();T.formatCode(e).then(t=>{if(!t.ok){this.clearTerminal(),this.writeToTerminal(t.output);return}this.editor.setCode(t.output,!0),this.writeToTerminal("Code formatted successfully!")}).catch(t=>{console.log(t),this.writeToTerminal("Can't format code. Please try again.")})}shareCode(){this.clearTerminal();let e=this.editor.getCode();T.shareCode(e).then(t=>{this.writeToTerminal("Code shared successfully!"),this.queryParams.updateURLParameter(p.QUERY_PARAM_NAME,t.hash);let n=this.buildShareLink(t);this.writeToTerminal("Share link: "+n),ne(n,()=>{this.writeToTerminal(`
Link copied to clipboard.`)}),this.writeToTerminal("Note: current page has changed its own URL, it now links to shared code.")}).catch(t=>{console.log(t),this.writeToTerminal("Can't share code. Please try again.")})}buildShareLink(e){let t=window.location.href.split("?")[0];return t.endsWith("/")||(t+="/"),t+"p/"+e.hash}changeTheme(){this.themeManager.toggleTheme()}setupShortcuts(){this.editor.editor.on("keypress",(e,t)=>{!e.state.completionActive&&t.key.length===1&&t.key.match(/[a-z0-9]/i)&&this.editor.showCompletion()}),document.addEventListener("keydown",e=>{this.repository instanceof p&&!e.ctrlKey&&!e.metaKey&&this.markCodeAsUnsaved();let n=e.ctrlKey&&e.key==="Enter",l=e.ctrlKey&&e.key==="r",u=e.shiftKey&&e.key==="Enter";n||l||u?(this.run(),e.preventDefault()):e.ctrlKey&&e.key==="l"?(this.formatCode(),e.preventDefault()):e.ctrlKey&&e.key==="="?(this.editor.changeEditorFontSize(1),e.preventDefault()):e.ctrlKey&&e.key==="-"?(this.editor.changeEditorFontSize(-1),e.preventDefault()):e.ctrlKey&&e.key==="i"?(this.helpManager.toggleHelp(),e.preventDefault()):(e.ctrlKey||e.metaKey)&&e.key==="s"?(this.editor.saveCode(),e.preventDefault()):e.key==="Escape"?(this.helpManager.closeHelp(),e.preventDefault()):this.editor.saveCode()})}askLoadUnsavedCode(){let e=this.repository instanceof p,t=window.localStorage.getItem(X)!=null;window.localStorage.removeItem(X),e&&t&&confirm("You have previously unsaved changes. Do you want to load it?")&&(this.queryParams.updateURLParameter(p.QUERY_PARAM_NAME,null),window.location.reload())}clearTerminal(){this.editor.terminal.clear()}writeToTerminal(e){this.editor.terminal.write(e)}markCodeAsUnsaved(){window.localStorage.setItem(X,"")}};var pe=document.querySelector(".js-playground"),y=new V(pe);y.registerAction("run",()=>{y.run()});y.registerAction("format",()=>{y.formatCode()});y.registerAction("share",()=>{y.shareCode()});y.registerAction("change-theme",()=>{y.changeTheme()});y.registerRunAsTestConsumer(()=>document.querySelector(".js-playground__action-run").getAttribute("data-type")==="Test");y.setupShortcuts();y.askLoadUnsavedCode();window.onload=()=>{let r=document.querySelector("html");r.style.opacity="1"};})();
