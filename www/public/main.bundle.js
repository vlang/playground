"use strict";(()=>{var ae=Object.defineProperty;var le=(s,e,t)=>e in s?ae(s,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):s[e]=t;var m=(s,e,t)=>(le(s,typeof e!="symbol"?e+"":e,t),t);var P=class{constructor(e,t,n,a,u){this.indentation=e;this.column=t;this.type=n;this.align=a;this.prev=u}insideString=!1;stringQuote=null;expectedImportName=!1;knownImports=new Set},U=new Set(["as","asm","assert","atomic","break","const","continue","defer","else","enum","fn","for","go","goto","if","import","in","interface","is","isreftype","lock","match","module","mut","none","or","pub","return","rlock","select","shared","sizeof","static","struct","spawn","type","typeof","union","unsafe","volatile","__offsetof"]),j=new Set(["sql","chan","thread"]),Q=new Set(["true","false","nil","print","println","exit","panic","error","dump"]),$=new Set(["bool","string","i8","i16","int","i64","i128","u8","u16","u32","u64","u128","rune","f32","f64","isize","usize","voidptr","any"]);CodeMirror.defineMode("v",s=>{let e=s.indentUnit??0,t=/[+\-*&^%:=<>!|\/]/,n=null;function a(o){return o.eatWhile(/[\w$_\xa1-\uffff]/),o.current()}function u(o,i){let r=o.next();if(r===null)return null;if(i.context.insideString&&r==="}")return o.eat("}"),i.tokenize=h(i.context.stringQuote),"end-interpolation";if(r==='"'||r==="'"||r==="`")return i.tokenize=h(r),i.tokenize(o,i);if(/[\d.]/.test(r)){if(r==="."){if(!o.match(/^[0-9_]+([eE][\-+]?[0-9_]+)?/))return"operator"}else r==="0"?o.match(/^[xX][0-9a-fA-F_]+/)||o.match(/^0[0-7_]+/):o.match(/^[0-9_]*\.?[0-9_]*([eE][\-+]?[0-9_]+)?/);return"number"}if(/[\[\]{}(),;:.]/.test(r))return n=r,null;if(r==="/"){if(o.eat("*"))return i.tokenize=b,b(o,i);if(o.eat("/"))return o.skipToEnd(),"comment"}if(t.test(r))return o.eatWhile(t),"operator";if(r==="@")return a(o),"at-identifier";if(r==="$"){let w=a(o).slice(1);return U.has(w)?"keyword":"compile-time-identifier"}let c=a(o);if(c==="import"&&(i.context.expectedImportName=!0),U.has(c)||j.has(c))return"keyword";if(Q.has(c))return"atom";if($.has(c))return"builtin";if(c[0].toUpperCase()===c[0])return"type";let f=o.peek();if(f==="("||f==="<")return"function";if(f==="["){o.next();let w=o.next();if(o.backUp(2),w!=null&&w.match(/[A-Z]/i))return"function"}return i.context.expectedImportName&&o.peek()!="."?(i.context.expectedImportName=!1,i.context.knownImports===void 0&&(i.context.knownImports=new Set),i.context.knownImports.add(c),"import-name"):i.context.knownImports.has(c)&&o.peek()=="."?"import-name":"variable"}function l(o,i){return o.match("}")?(i.tokenize=h(i.context.stringQuote),"end-interpolation"):(i.tokenize=u,i.tokenize(o,i))}function d(o,i){let r=o.next();if(r===" ")return i.tokenize=h(i.context.stringQuote),i.tokenize(o,i);if(r===".")return"operator";let c=a(o);if(c[0].toLowerCase()===c[0].toUpperCase())return i.tokenize=h(i.context.stringQuote),i.tokenize(o,i);let f=o.next();return o.backUp(1),f==="."?i.tokenize=d:i.tokenize=h(i.context.stringQuote),"variable"}function g(o,i){let r=o.next();return r==="$"&&o.eat("{")?(i.tokenize=l,"start-interpolation"):r==="$"?(i.tokenize=d,"start-interpolation"):"string"}function h(o){return function(i,r){r.context.insideString=!0,r.context.stringQuote=o;let c="",f=!1,w=!1;for(;(c=i.next())!=null;){if(c===o&&!f){w=!0;break}if(c==="$"&&!f&&i.eat("{"))return r.tokenize=g,i.backUp(2),"string";if(c==="$"&&!f)return r.tokenize=g,i.backUp(1),"string";f=!f&&c==="\\"}return(w||f)&&(r.tokenize=u),r.context.insideString=!1,r.context.stringQuote=null,"string"}}function b(o,i){let r=!1,c;for(;c=o.next();){if(c==="/"&&r){i.tokenize=u;break}r=c==="*"}return"comment"}function V(o,i,r){return o.context=new P(o.indention,i,r,null,o.context)}function X(o){if(!o.context.prev)return;let i=o.context.type;return(i===")"||i==="]"||i==="}")&&(o.indention=o.context.indentation),o.context=o.context.prev,o.context}return{startState:function(){return{tokenize:null,context:new P(0,0,"top",!1),indention:0,startOfLine:!0}},token:function(o,i){let r=i.context;if(o.sol()&&(r.align==null&&(r.align=!1),i.indention=o.indentation(),i.startOfLine=!0),o.eatSpace())return null;n=null;let c=(i.tokenize||u)(o,i);return c==="comment"||(r.align==null&&(r.align=!0),n==="{"?V(i,o.column(),"}"):n==="["?V(i,o.column(),"]"):n==="("?V(i,o.column(),")"):(n==="}"&&r.type==="}"||n===r.type)&&X(i),i.startOfLine=!1),c},indent:function(o,i){if(o.tokenize!==u&&o.tokenize!=null||o.context.type=="top")return 0;let r=o.context,f=i.charAt(0)===r.type;return r.align?r.column+(f?0:1):r.indentation+(f?0:e)},electricChars:"{}):",closeBrackets:"()[]{}''\"\"``",fold:"brace",blockCommentStart:"/*",blockCommentEnd:"*/",lineComment:"//"}});CodeMirror.defineMIME("text/x-v","v");var D=CodeMirror.Pos,ue=["arrays","benchmark","bitfield","cli","clipboard","compress","context","crypto","darwin","datatypes","dl","dlmalloc","encoding","eventbus","flag","fontstash","gg","gx","hash","io","js","json","log","math","mssql","mysql","net","orm","os","pg","picoev","picohttpparser","rand","readline","regex","runtime","semver","sokol","sqlite","stbi","strconv","strings","sync","szip","term","time","toml","v","vweb","x"];function ce(s){let e=[],t=s.getCursor(),n=s.getTokenAt(t),a=new Set;for(let g=0;g<Math.min(s.lineCount(),10);g++){let h=s.getLineTokens(g).filter(b=>b.type!=null);h.length>0&&h[0].string==="import"&&a.add(h[h.length-1].string)}let u=s.getLineTokens(t.line);u.length>0&&u[0].string==="import"&&e.push(u[0]);let l=n.string.length,d=s.getTokenAt(D(t.line,t.ch-l));return n.string==="."&&e.push(n),d.string==="."&&e.push(d),/\b(?:string|comment)\b/.test(n.type??"")?null:(/^[\w$_]*$/.test(n.string)?n.end>t.ch&&(n.end=t.ch,n.string=n.string.slice(0,t.ch-n.start)):n={start:t.ch,end:t.ch,string:"",state:n.state,type:n.string==="."?"property":null},{list:de(n,a,e),from:D(t.line,n.start),to:D(t.line,n.end)})}function de(s,e,t){let n=[],a=s.string;function u(l){let d=l.text;if(d.indexOf(a)===-1)return;n.find(h=>h.text===d)||n.push(l)}if(t&&t.length){let l=t.pop();if(l!==void 0){if(l.type==="keyword"&&l.string==="import")return ue.forEach(d=>{u({text:d,displayText:d,className:"completion-module"})}),n;if(l.string===".")return[]}}return e.forEach(l=>{u({text:l,displayText:l,className:"completion-module"})}),U.forEach(l=>{u({text:l+" ",displayText:l,className:"completion-keyword"})}),j.forEach(l=>{u({text:l+" ",displayText:l,className:"completion-keyword"})}),Q.forEach(l=>{u({text:l,displayText:l,className:"completion-atom"})}),$.forEach(l=>{u({text:l,displayText:l,className:"completion-type"})}),n}var me=s=>ce(s);CodeMirror.registerHelper("hint","v",me);var p=class{hash;constructor(e){this.hash=e}saveCode(e){}getCode(e){return this.getSharedCode(e)}getSharedCode(e){let t=new FormData;t.append("hash",this.hash),fetch("/query",{method:"post",body:t}).then(n=>n.text()).then(n=>{e(n)}).catch(n=>{console.log(n)})}};m(p,"QUERY_PARAM_NAME","query"),m(p,"CODE_NOT_FOUND","Not found.");var R=class{constructor(e){this.text=e}saveCode(e){}getCode(e){e(this.text)}};var M=class{saveCode(e){window.localStorage.setItem(M.LOCAL_STORAGE_KEY,e)}getCode(e){let t=window.localStorage.getItem(M.LOCAL_STORAGE_KEY);if(t==null){e(M.WELCOME_CODE);return}e(t)}},C=M;m(C,"LOCAL_STORAGE_KEY","code"),m(C,"WELCOME_CODE",`
...
// Enjoy!
`.trimStart());var E=class{constructor(e){this.text=e;this.decodedCode=atob(e)}decodedCode;saveCode(e){}getCode(e){e(this.decodedCode)}};m(E,"QUERY_PARAM_NAME","base64");var N=class{static selectRepository(e,t){if(t!==void 0&&t.codeHash!==null&&t.codeHash!==void 0)return new p(t.codeHash);if(t!==void 0&&t.code!==null&&t.code!==void 0)return new R(t.code);if(t!==void 0&&t.embed!==null&&t.embed!==void 0&&t.embed)return new R("");let n=new C,a=e.getURLParameter(p.QUERY_PARAM_NAME);if(a!=null)return new p(a);let u=e.getURLParameter(E.QUERY_PARAM_NAME);return u!=null?new E(u):n}};var L=class{params;constructor(e){this.params=new URLSearchParams(e)}updateURLParameter(e,t){let n=L.updateURLParameter(window.location.href,e,t);window.history.replaceState({},"",n)}getURLParameter(e){return this.params.get(e)}static updateURLParameter(e,t,n){let a=new URL(e);return n?a.searchParams.set(t,n):a.searchParams.delete(t),a.toString()}};var Y=class{containingElement;element;helpOverlay;showHelpButton;closeHelpButton;constructor(e){this.containingElement=e,this.element=e.getElementsByClassName("js-help-wrapper")[0],!(this.element===null||this.element===void 0)&&(this.helpOverlay=this.element.querySelector(".js-help-overlay"),this.showHelpButton=this.element.querySelector(".js-show-help"),this.closeHelpButton=this.element.querySelector(".js-close-help"),this.mount())}mount(){this.showHelpButton!==void 0&&this.showHelpButton.addEventListener("click",()=>{this.toggleHelp()}),this.helpOverlay!==void 0&&this.helpOverlay.addEventListener("click",()=>{this.toggleHelp()}),this.closeHelpButton!==void 0&&this.closeHelpButton.addEventListener("click",()=>{this.toggleHelp()}),Y.isMac||document.querySelectorAll(".js-shortcut kbd.ctrl").forEach(function(t){t.innerText="Ctrl"})}closeHelp(){this.helpOverlay.classList.contains("opened")&&this.toggleHelp()}toggleHelp(){this.containingElement.getElementsByClassName("js-help")[0].classList.toggle("opened"),this.helpOverlay.classList.toggle("opened")}},H=Y;m(H,"isMac",navigator.platform.toUpperCase().indexOf("MAC")>=0);function ee(s){let e=document.createElement("textarea");e.value=s,e.style.top="0",e.style.left="0",e.style.position="fixed",document.body.appendChild(e),e.focus(),e.select();try{let n=document.execCommand("copy")?"successful":"unsuccessful";console.log("Fallback: Copying text command was "+n)}catch(t){console.log("Fallback: Oops, unable to copy",t)}document.body.removeChild(e)}function te(s,e){if(!navigator.clipboard){ee(s);return}navigator.clipboard.writeText(s).then(function(){console.log("Async: Copying to clipboard was successful!"),e()},function(t){ee(s),console.log("Async: Could not copy text: ",t,"fallback to old method")})}var B=class{element;onClose=null;onWrite=null;filters=[];constructor(e){this.element=e,this.attachResizeHandler(e)}registerCloseHandler(e){this.onClose=e}registerWriteHandler(e){this.onWrite=e}registerFilter(e){this.filters.push(e)}write(e){let t=e.split(`
...
`.trimStart();var q=class{wrapperElement;repository;editor;terminal;constructor(e,t){let n={mode:"v",lineNumbers:!0,matchBrackets:!0,extraKeys:{"Ctrl-Space":"autocomplete","Ctrl-/":"toggleComment"},indentWithTabs:!0,indentUnit:4,autoCloseBrackets:!0,showHint:!0,lint:{async:!0,lintOnChange:!0,delay:20},toggleLineComment:{indent:!0,padding:" "},theme:"dark"};this.wrapperElement=e;let a=e.querySelector("textarea");this.editor=CodeMirror.fromTextArea(a,n),this.repository=t,this.repository.getCode(l=>{if(l===p.CODE_NOT_FOUND){this.setCode(ie),this.terminal.write("Code for shared link not found.");return}this.setCode(l)});let u=e.querySelector(".js-terminal");if(u==null)throw new Error("Terminal not found, please check that terminal inside editor element");this.terminal=new B(u),this.terminal.registerCloseHandler(()=>{this.closeTerminal(),this.editor.refresh()}),this.terminal.registerWriteHandler(l=>{this.openTerminal()}),this.terminal.registerFilter(l=>!l.trim().startsWith("Failed command")),this.terminal.mount(),this.initFont()}initFont(){let e=window.localStorage.getItem(q.FONT_LOCAL_STORAGE_KEY);e!==null&&this.setEditorFontSize(e)}changeEditorFontSize(e){let t=document.getElementsByClassName("CodeMirror")[0],n=window.getComputedStyle(t,null).getPropertyValue("font-size");if(n){let a=parseInt(n)+e;t.style.fontSize=a+"px",window.localStorage.setItem(q.FONT_LOCAL_STORAGE_KEY,a.toString()),this.editor.refresh()}}setEditorFontSize(e){let t=document.getElementsByClassName("CodeMirror")[0];t.style.fontSize=e+"px",this.refresh()}setCode(e,t=!1){let n=this.editor.getCursor();this.editor.setValue(e),this.repository.saveCode(e),t&&this.editor.setCursor(n)}getCode(){return this.editor.getValue()}saveCode(){this.repository instanceof p&&(this.repository=new C),this.repository.saveCode(this.getCode())}openTerminal(){this.wrapperElement.classList.remove("closed-terminal")}closeTerminal(){this.wrapperElement.classList.add("closed-terminal")}setTheme(e){this.editor.setOption("theme",e.name())}showCompletion(){this.editor.execCommand("autocomplete")}refresh(){this.editor.refresh()}},A=q;m(A,"FONT_LOCAL_STORAGE_KEY","editor-font-size");var v=class{name(){return"dark"}};var O=class{name(){return"light"}};var re=`<span class="icon">
