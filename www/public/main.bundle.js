"use strict";(()=>{var ye=Object.defineProperty;var Ce=(s,e,t)=>e in s?ye(s,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):s[e]=t;var h=(s,e,t)=>(Ce(s,typeof e!="symbol"?e+"":e,t),t);var Q=CodeMirror.Pos,be=["arrays","benchmark","bitfield","cli","clipboard","compress","context","crypto","darwin","datatypes","dl","dlmalloc","encoding","eventbus","flag","fontstash","gg","gx","hash","io","js","json","log","math","mssql","mysql","net","orm","os","pg","picoev","picohttpparser","rand","readline","regex","runtime","semver","sokol","sqlite","stbi","strconv","strings","sync","szip","term","time","toml","v","vweb","x"],ie=["params","noinit","required","skip","assert_continues","unsafe","manualfree","heap","nonnull","primary","inline","direct_array_access","live","flag","noinline","noreturn","typedef","console","sql","table","deprecated","deprecated_after","export","callconv"],D="[\\w_]+",oe=new RegExp(`^(${ie.join("|")})]$`),re=`(${D}: ${D})`,se=new RegExp(`^${re}]$`),ae=new RegExp(`^(${ie.join("|")}(; ?)?){2,}]$`),le=new RegExp(`^((${re})(; )?){2,}]$`),ue=new RegExp(`^if ${D} \\??]`);function we(s){let e=[],t=s.getCursor(),n=s.getTokenAt(t),l=new Set;for(let g=0;g<Math.min(s.lineCount(),10);g++){let p=s.getLineTokens(g).filter(b=>b.type!=null);p.length>0&&p[0].string==="import"&&l.add(p[p.length-1].string)}let u=s.getLineTokens(t.line);u.length>0&&u[0].string==="import"&&e.push(u[0]);let a=n.string.length,c=s.getTokenAt(Q(t.line,t.ch-a));return n.string==="."&&e.push(n),c.string==="."&&e.push(c),/\b(?:string|comment)\b/.test(n.type??"")?null:(/^[\w$_]*$/.test(n.string)?n.end>t.ch&&(n.end=t.ch,n.string=n.string.slice(0,t.ch-n.start)):n={start:t.ch,end:t.ch,string:"",state:n.state,type:n.string==="."?"property":null},{list:ve(n,l,e),from:Q(t.line,n.start),to:Q(t.line,n.end)})}function ve(s,e,t){let n=[],l=s.string;function u(a){let c=a.text;if(!c.startsWith(l))return;n.find(p=>p.text===c)||n.push(a)}if(t&&t.length){let a=t.pop();if(a!==void 0){if(a.type==="keyword"&&a.string==="import")return be.forEach(c=>{u({text:c,displayText:c,className:"completion-module"})}),n;if(a.string===".")return[]}}return e.forEach(a=>{u({text:a,displayText:a,className:"completion-module"})}),N.forEach(a=>{u({text:a+" ",displayText:a,className:"completion-keyword"})}),Y.forEach(a=>{u({text:a+" ",displayText:a,className:"completion-keyword"})}),K.forEach(a=>{u({text:a,displayText:a,className:"completion-atom"})}),G.forEach(a=>{u({text:a,displayText:a,className:"completion-type"})}),n}var Te=s=>we(s);CodeMirror.registerHelper("hint","v",Te);var B=class{constructor(e,t,n,l,u){this.indentation=e;this.column=t;this.type=n;this.align=l;this.prev=u}insideString=!1;stringQuote=null;expectedImportName=!1;knownImports=new Set},N=new Set(["as","asm","assert","atomic","break","const","continue","defer","else","enum","fn","for","go","goto","if","import","in","interface","is","isreftype","lock","match","module","mut","none","or","pub","return","rlock","select","shared","sizeof","static","struct","spawn","type","typeof","union","unsafe","volatile","__offsetof"]),Y=new Set(["sql","chan","thread"]),K=new Set(["true","false","nil","print","println","exit","panic","error","dump"]),G=new Set(["bool","string","i8","i16","int","i64","i128","u8","u16","u32","u64","u128","rune","f32","f64","isize","usize","voidptr","any"]);CodeMirror.defineMode("v",s=>{let e=s.indentUnit??0,t=/[+\-*&^%:=<>!?|\/]/,n=null;function l(i){return i.eatWhile(/[\w$_\xa1-\uffff]/),i.current()}function u(i,o){let r=i.next();if(r===null)return null;if(o.context.insideString&&r==="}")return i.eat("}"),o.tokenize=p(o.context.stringQuote),"end-interpolation";if(r==='"'||r==="'"||r==="`")return o.tokenize=p(r),o.tokenize(i,o);if(r==="."&&!i.match(/^[0-9]+([eE][\-+]?[0-9]+)?/))return"operator";if(r==="["&&(i.match(oe)||i.match(se)||i.match(ae)||i.match(le)||i.match(ue)))return"attribute";if(/[\d.]/.test(r))return r==="0"?i.match(/^[xX][0-9a-fA-F_]+/)||i.match(/^o[0-7_]+/)||i.match(/^b[0-1_]+/):i.match(/^[0-9_]*\.?[0-9_]*([eE][\-+]?[0-9_]+)?/),"number";if(/[\[\]{}(),;:.]/.test(r))return n=r,null;if(r==="/"){if(i.eat("*"))return o.tokenize=b,b(i,o);if(i.eat("/"))return i.skipToEnd(),"comment"}if(t.test(r))return i.eatWhile(t),"operator";if(r==="@")return l(i),"at-identifier";if(r==="$"){let U=l(i).slice(1);return N.has(U)?"keyword":"compile-time-identifier"}i.backUp(2);let m=i.next()===".";i.next();let d=l(i);if(d==="import"&&(o.context.expectedImportName=!0),N.has(d)||Y.has(d))return"keyword";if(K.has(d))return"atom";if(G.has(d))return"builtin";if(d.length>0&&d[0].toUpperCase()===d[0])return"type";let T=i.peek();if(T==="("||T==="<")return"function";if(T==="["){i.next();let U=i.next();if(i.backUp(2),U!=null&&U.match(/[A-Z]/i))return"function"}return m?"property":o.context.expectedImportName&&i.peek()!="."?(o.context.expectedImportName=!1,o.context.knownImports===void 0&&(o.context.knownImports=new Set),o.context.knownImports.add(d),"import-name"):o.context.knownImports.has(d)&&i.peek()=="."?"import-name":"variable"}function a(i,o){return i.match("}")?(o.tokenize=p(o.context.stringQuote),"end-interpolation"):(o.tokenize=u,o.tokenize(i,o))}function c(i,o){let r=i.next();if(r===" ")return o.tokenize=p(o.context.stringQuote),o.tokenize(i,o);if(r===".")return"operator";let m=l(i);if(m[0].toLowerCase()===m[0].toUpperCase())return o.tokenize=p(o.context.stringQuote),o.tokenize(i,o);let d=i.next();return i.backUp(1),d==="."?o.tokenize=c:o.tokenize=p(o.context.stringQuote),"variable"}function g(i,o){let r=i.next();return r==="$"&&i.eat("{")?(o.tokenize=a,"start-interpolation"):r==="$"?(o.tokenize=c,"start-interpolation"):"string"}function p(i){return function(o,r){r.context.insideString=!0,r.context.stringQuote=i;let m="",d=!1,T=!1;for(;(m=o.next())!=null;){if(m===i&&!d){T=!0;break}if(m==="$"&&!d&&o.eat("{"))return r.tokenize=g,o.backUp(2),"string";if(m==="$"&&!d)return r.tokenize=g,o.backUp(1),"string";d=!d&&m==="\\"}return(T||d)&&(r.tokenize=u),r.context.insideString=!1,r.context.stringQuote=null,"string"}}function b(i,o){let r=!1,m;for(;m=i.next();){if(m==="/"&&r){o.tokenize=u;break}r=m==="*"}return"comment"}function $(i,o,r){return i.context=new B(i.indention,o,r,null,i.context)}function ne(i){if(!i.context.prev)return;let o=i.context.type;return(o===")"||o==="]"||o==="}")&&(i.indention=i.context.indentation),i.context=i.context.prev,i.context}return{startState:function(){return{tokenize:null,context:new B(0,0,"top",!1),indention:0,startOfLine:!0}},token:function(i,o){let r=o.context;if(i.sol()&&(r.align==null&&(r.align=!1),o.indention=i.indentation(),o.startOfLine=!0),i.eatSpace())return null;n=null;let m=(o.tokenize||u)(i,o);return m==="comment"||(r.align==null&&(r.align=!0),n==="{"?$(o,i.column(),"}"):n==="["?$(o,i.column(),"]"):n==="("?$(o,i.column(),")"):(n==="}"&&r.type==="}"||n===r.type)&&ne(o),o.startOfLine=!1),m},indent:function(i,o){if(i.tokenize!==u&&i.tokenize!=null||i.context.type=="top")return 0;let r=i.context,d=o.charAt(0)===r.type;return r.align?r.column+(d?0:1):r.indentation+(d?0:e)},electricChars:"{}):",closeBrackets:"()[]{}''\"\"``",fold:"brace",blockCommentStart:"/*",blockCommentEnd:"*/",lineComment:"//"}});CodeMirror.defineMIME("text/x-v","v");var f=class{hash;constructor(e){this.hash=e}saveCode(e){}getCode(e){return this.getSharedCode(e)}getSharedCode(e){let t=new FormData;t.append("hash",this.hash),fetch("/query",{method:"post",body:t}).then(n=>n.text()).then(n=>{e(n)}).catch(n=>{console.log(n)})}};h(f,"QUERY_PARAM_NAME","query"),h(f,"CODE_NOT_FOUND","Not found.");var M=class{constructor(e){this.text=e}saveCode(e){}getCode(e){e(this.text)}};var A=class{saveCode(e){window.localStorage.setItem(A.LOCAL_STORAGE_KEY,e)}getCode(e){let t=window.localStorage.getItem(A.LOCAL_STORAGE_KEY);if(t==null){e(A.WELCOME_CODE);return}e(t)}},C=A;h(C,"LOCAL_STORAGE_KEY","code"),h(C,"WELCOME_CODE",`
...
// Enjoy!
`.trimStart());var E=class{constructor(e){this.text=e;this.decodedCode=atob(e)}decodedCode;saveCode(e){}getCode(e){e(this.decodedCode)}};h(E,"QUERY_PARAM_NAME","base64");var x=class{constructor(e){this.id=e}saveCode(e){}getCode(e){fetch("https://api.github.com/gists/"+this.id,{method:"get",headers:{"Content-Type":"application/json"}}).then(t=>t.json()).then(t=>{let n=t.files,l=Object.keys(n)[0],a=n[l].raw_url;fetch(a,{method:"get",headers:{"Content-Type":"text/plain"}}).then(c=>c.text()).then(c=>{e(c)}).catch(c=>{console.log(c)})}).catch(t=>{console.log(t)})}};h(x,"QUERY_PARAM_NAME","gist");var V=class{static selectRepository(e,t){if(t!==void 0&&t.codeHash!==null&&t.codeHash!==void 0)return new f(t.codeHash);if(t!==void 0&&t.code!==null&&t.code!==void 0)return new M(t.code);if(t!==void 0&&t.embed!==null&&t.embed!==void 0&&t.embed)return new M("");let n=new C,l=e.getURLParameter(f.QUERY_PARAM_NAME);if(l!=null)return new f(l);let u=e.getURLParameter(E.QUERY_PARAM_NAME);if(u!=null)return new E(u);let a=e.getURLParameter(x.QUERY_PARAM_NAME);return a!=null?new x(a):n}};var L=class{params;constructor(e){this.params=new URLSearchParams(e)}updateURLParameter(e,t){let n=L.updateURLParameter(window.location.href,e,t);window.history.replaceState({},"",n)}getURLParameter(e){return this.params.get(e)}static updateURLParameter(e,t,n){let l=new URL(e);return n?l.searchParams.set(t,n):l.searchParams.delete(t),l.toString()}};var W=class{containingElement;element;helpOverlay;showHelpButton;closeHelpButton;constructor(e){this.containingElement=e,this.element=e.getElementsByClassName("js-help-wrapper")[0],!(this.element===null||this.element===void 0)&&(this.helpOverlay=this.element.querySelector(".js-help-overlay"),this.showHelpButton=this.element.querySelector(".js-show-help"),this.closeHelpButton=this.element.querySelector(".js-close-help"),this.mount())}mount(){this.showHelpButton!==void 0&&this.showHelpButton.addEventListener("click",()=>{this.toggleHelp()}),this.helpOverlay!==void 0&&this.helpOverlay.addEventListener("click",()=>{this.toggleHelp()}),this.closeHelpButton!==void 0&&this.closeHelpButton.addEventListener("click",()=>{this.toggleHelp()}),W.isMac||document.querySelectorAll(".js-shortcut kbd.ctrl").forEach(function(t){t.innerText="Ctrl"})}closeHelp(){this.helpOverlay.classList.contains("opened")&&this.toggleHelp()}toggleHelp(){this.containingElement.getElementsByClassName("js-help")[0].classList.toggle("opened"),this.helpOverlay.classList.toggle("opened")}},H=W;h(H,"isMac",navigator.platform.toUpperCase().indexOf("MAC")>=0);function ce(s){let e=document.createElement("textarea");e.value=s,e.style.top="0",e.style.left="0",e.style.position="fixed",document.body.appendChild(e),e.focus(),e.select();try{let n=document.execCommand("copy")?"successful":"unsuccessful";console.log("Fallback: Copying text command was "+n)}catch(t){console.log("Fallback: Oops, unable to copy",t)}document.body.removeChild(e)}function de(s,e){if(!navigator.clipboard){ce(s);return}navigator.clipboard.writeText(s).then(function(){console.log("Async: Copying to clipboard was successful!"),e()},function(t){ce(s),console.log("Async: Could not copy text: ",t,"fallback to old method")})}var q=class{element;onClose=null;onWrite=null;filters=[];constructor(e){this.element=e,this.attachResizeHandler(e)}registerCloseHandler(e){this.onClose=e}registerWriteHandler(e){this.onWrite=e}registerFilter(e){this.filters.push(e)}write(e){let t=e.split(`
...
`.trimStart();var j=class{wrapperElement;repository;editor;terminal;constructor(e,t){let n={mode:"v",lineNumbers:!0,matchBrackets:!0,extraKeys:{"Ctrl-Space":"autocomplete","Ctrl-/":"toggleComment"},indentWithTabs:!0,indentUnit:4,autoCloseBrackets:!0,showHint:!0,lint:{async:!0,lintOnChange:!0,delay:20},toggleLineComment:{indent:!0,padding:" "},theme:"dark"};this.wrapperElement=e;let l=e.querySelector("textarea");this.editor=CodeMirror.fromTextArea(l,n),this.repository=t,this.repository.getCode(a=>{if(a===f.CODE_NOT_FOUND){this.setCode(pe),this.terminal.write("Code for shared link not found.");return}this.setCode(a)});let u=e.querySelector(".js-terminal");if(u==null)throw new Error("Terminal not found, please check that terminal inside editor element");this.terminal=new q(u),this.terminal.registerCloseHandler(()=>{this.closeTerminal(),this.editor.refresh()}),this.terminal.registerWriteHandler(a=>{this.openTerminal()}),this.terminal.registerFilter(a=>!a.trim().startsWith("Failed command")),this.terminal.mount(),this.initFont()}initFont(){let e=window.localStorage.getItem(j.FONT_LOCAL_STORAGE_KEY);e!==null&&this.setEditorFontSize(e)}changeEditorFontSize(e){let t=document.getElementsByClassName("CodeMirror")[0],n=window.getComputedStyle(t,null).getPropertyValue("font-size");if(n){let l=parseInt(n)+e;t.style.fontSize=l+"px",window.localStorage.setItem(j.FONT_LOCAL_STORAGE_KEY,l.toString()),this.editor.refresh()}}setEditorFontSize(e){let t=document.getElementsByClassName("CodeMirror")[0];t.style.fontSize=e+"px",this.refresh()}setCode(e,t=!1){let n=this.editor.getCursor();this.editor.setValue(e),this.repository.saveCode(e),t&&this.editor.setCursor(n)}getCode(){return this.editor.getValue()}saveCode(){this.repository instanceof f&&(this.repository=new C),this.repository.saveCode(this.getCode())}openTerminal(){this.wrapperElement.classList.remove("closed-terminal")}closeTerminal(){this.wrapperElement.classList.add("closed-terminal")}setTheme(e){this.editor.setOption("theme",e.name())}showCompletion(){this.editor.execCommand("autocomplete")}refresh(){this.editor.refresh()}},O=j;h(O,"FONT_LOCAL_STORAGE_KEY","editor-font-size");var w=class{name(){return"dark"}};var P=class{name(){return"light"}};var fe=`<span class="icon">
...
`;var R=class{themes=[new w,new P];currentTheme=null;onChange=[];queryParams;changeThemeButton=null;predefinedTheme=null;fromQueryParam=!1;constructor(e,t=null){this.queryParams=e,this.predefinedTheme=t,this.changeThemeButton=document.querySelector(".js-playground__action-change-theme")}registerOnChange(e){this.onChange.push(e)}loadTheme(){let e=this.queryParams.getURLParameter(R.QUERY_PARAM_NAME);if(e!=null){this.fromQueryParam=!0;let n=this.findTheme(e);this.turnTheme(n);return}let t=window.localStorage.getItem(R.LOCAL_STORAGE_KEY);if(t!=null){let n=this.findTheme(t);this.turnTheme(n);return}if(this.predefinedTheme!==null&&this.predefinedTheme!==void 0){this.turnTheme(this.predefinedTheme);return}this.turnTheme(new w)}findTheme(e){let t=this.themes.filter(l=>l.name()===e),n=t[0];return t.length==0&&(n=new w),n}turnTheme(e){this.currentTheme=e,this.onChange.forEach(l=>l(e));let t=fe;e.name()==="dark"&&(t=ge),this.changeThemeButton!==null&&(this.changeThemeButton.innerHTML=t),document.querySelector("html").setAttribute("data-theme",e.name()),this.fromQueryParam||window.localStorage.setItem(R.LOCAL_STORAGE_KEY,e.name()),this.fromQueryParam&&this.queryParams.updateURLParameter(R.QUERY_PARAM_NAME,e.name())}turnDarkTheme(){this.turnTheme(new w)}turnLightTheme(){this.turnTheme(new P)}toggleTheme(){this.currentTheme&&(this.currentTheme.name()==="light"?this.turnDarkTheme():this.turnLightTheme())}},k=R;h(k,"QUERY_PARAM_NAME","theme"),h(k,"LOCAL_STORAGE_KEY","theme");var X=class{selectElement;onSelectHandler=null;constructor(){this.selectElement=document.querySelector(".js-examples__select")}registerOnSelectHandler(e){this.onSelectHandler=e}mount(){if(this.selectElement===null||this.selectElement===void 0)return;let e=this.selectElement.querySelector(".dropdown__list"),t=this.selectElement.querySelector(".dropdown__button");e!==null&&t!==null&&(F.forEach(function(c,g){e.innerHTML+=X.exampleElementListTemplate(c.name,g)}),t.innerHTML=F[0].name);let n=this.selectElement.querySelectorAll(".dropdown__list-item");n.forEach(c=>{c.addEventListener("click",()=>{let g=c.innerText,p=F.find(b=>b.name===g);this.onSelectHandler!==null&&p&&this.onSelectHandler(p)})});let l=this.selectElement.querySelector(".dropdown__button"),u=this.selectElement.querySelector(".dropdown__list"),a=this.selectElement.querySelector(".dropdown__input_hidden");l.addEventListener("click",function(){u.classList.toggle("dropdown__list_visible"),this.classList.toggle("dropdown__button_active")}),n.forEach(function(c){c.addEventListener("click",function(g){n.forEach(function(b){b.classList.remove("dropdown__list-item_active")}),g.target.classList.add("dropdown__list-item_active"),l.innerText=this.innerText,a.value=this.dataset.value??"",u.classList.remove("dropdown__list_visible")})}),document.addEventListener("click",function(c){c.target!==l&&(l.classList.remove("dropdown__button_active"),u.classList.remove("dropdown__list_visible"))}),document.addEventListener("keydown",function(c){(c.key==="Tab"||c.key==="Escape")&&(l.classList.remove("dropdown__button_active"),u.classList.remove("dropdown__list_visible"))})}},I=X;h(I,"exampleElementListTemplate",function(e,t){let n="";return t===0&&(n="dropdown__list-item_active"),`
<li class="dropdown__list-item ${n}" data-value="${e}">${e}</li>
`});var ee=class{constructor(e){this.hash=e}},v=class{static runCode(e){let t=new FormData;return t.append("code",e),fetch("/run",{method:"post",body:t}).then(n=>{if(n.status!=200)throw new Error("Can't run code");return n}).then(n=>n.json()).then(n=>JSON.parse(n))}static runTest(e){let t=new FormData;return t.append("code",e),fetch("/run_test",{method:"post",body:t}).then(n=>{if(n.status!=200)throw new Error("Can't run test");return n}).then(n=>n.json()).then(n=>JSON.parse(n))}static formatCode(e){let t=new FormData;return t.append("code",e),fetch("/format",{method:"post",body:t}).then(n=>n.json()).then(n=>JSON.parse(n))}static shareCode(e){let t=new FormData;return t.append("code",e),fetch("/share",{method:"post",body:t}).then(n=>{if(n.status!=200)throw new Error("Can't share code");return n.text()}).then(n=>new ee(n))}};var te="unsaved",z=class{runAsTestConsumer=()=>!1;queryParams;repository;editor;themeManager;examplesManager;helpManager;runConfigurationManager;constructor(e){this.queryParams=new L(window.location.search),this.repository=V.selectRepository(this.queryParams),this.editor=new O(e,this.repository),this.themeManager=new k(this.queryParams),this.themeManager.registerOnChange(t=>{this.editor.setTheme(t)}),this.themeManager.loadTheme(),this.examplesManager=new I,this.examplesManager.registerOnSelectHandler(t=>{this.editor.setCode(t.code),this.runConfigurationManager.useConfiguration(t.runConfiguration)}),this.examplesManager.mount(),this.helpManager=new H(e),this.runConfigurationManager=new _(this.queryParams),this.runConfigurationManager.registerOnChange(()=>{}),this.runConfigurationManager.registerOnSelect(()=>{this.runConfigurationManager.toggleConfigurationsList(),this.run()}),this.runConfigurationManager.setupConfiguration()}registerRunAsTestConsumer(e){this.runAsTestConsumer=e}registerAction(e,t){let n=document.getElementsByClassName(`js-playground__action-${e}`)[0];if(n===void 0)throw new Error(`Can't find action button with class js-playground__action-${e}`);n.addEventListener("click",t)}run(){if(this.runAsTestConsumer()){this.runTest();return}this.runCode()}runCode(){this.clearTerminal(),this.writeToTerminal("Running code...");let e=this.editor.getCode();v.runCode(e).then(t=>{this.clearTerminal(),this.writeToTerminal(t.output)}).catch(t=>{console.log(t),this.writeToTerminal("Can't run code. Please try again.")})}runTest(){this.clearTerminal(),this.writeToTerminal("Running tests...");let e=this.editor.getCode();v.runTest(e).then(t=>{this.clearTerminal(),this.writeToTerminal(t.output)}).catch(t=>{console.log(t),this.writeToTerminal("Can't run tests. Please try again.")})}formatCode(){this.clearTerminal(),this.writeToTerminal("Formatting code...");let e=this.editor.getCode();v.formatCode(e).then(t=>{if(!t.ok){this.clearTerminal(),this.writeToTerminal(t.output);return}this.editor.setCode(t.output,!0),this.writeToTerminal("Code formatted successfully!")}).catch(t=>{console.log(t),this.writeToTerminal("Can't format code. Please try again.")})}shareCode(){this.clearTerminal();let e=this.editor.getCode();v.shareCode(e).then(t=>{this.writeToTerminal("Code shared successfully!"),this.queryParams.updateURLParameter(f.QUERY_PARAM_NAME,t.hash);let n=this.buildShareLink(t);this.writeToTerminal("Share link: "+n),de(n,()=>{this.writeToTerminal(`
Link copied to clipboard.`)}),this.writeToTerminal("Note: current page has changed its own URL, it now links to shared code.")}).catch(t=>{console.log(t),this.writeToTerminal("Can't share code. Please try again.")})}buildShareLink(e){let t=window.location.href.split("?")[0];return t.endsWith("/")||(t+="/"),t+"p/"+e.hash}changeTheme(){this.themeManager.toggleTheme()}setupShortcuts(){this.editor.editor.on("keypress",(e,t)=>{!e.state.completionActive&&t.key.length===1&&t.key.match(/[a-z0-9]/i)&&this.editor.showCompletion()}),document.addEventListener("keydown",e=>{this.repository instanceof f&&!e.ctrlKey&&!e.metaKey&&this.markCodeAsUnsaved();let n=e.ctrlKey&&e.key==="Enter",l=e.ctrlKey&&e.key==="r",u=e.shiftKey&&e.key==="Enter";n||l||u?(this.run(),e.preventDefault()):e.ctrlKey&&e.key==="l"?(this.formatCode(),e.preventDefault()):e.ctrlKey&&e.key==="="?(this.editor.changeEditorFontSize(1),e.preventDefault()):e.ctrlKey&&e.key==="-"?(this.editor.changeEditorFontSize(-1),e.preventDefault()):e.ctrlKey&&e.key==="i"?(this.helpManager.toggleHelp(),e.preventDefault()):(e.ctrlKey||e.metaKey)&&e.key==="s"?(this.editor.saveCode(),e.preventDefault()):e.key==="Escape"?(this.helpManager.closeHelp(),e.preventDefault()):this.editor.saveCode()})}askLoadUnsavedCode(){let e=this.repository instanceof f,t=window.localStorage.getItem(te)!=null;window.localStorage.removeItem(te),e&&t&&confirm("You have previously unsaved changes. Do you want to load it?")&&(this.queryParams.updateURLParameter(f.QUERY_PARAM_NAME,null),window.location.reload())}clearTerminal(){this.editor.terminal.clear()}writeToTerminal(e){this.editor.terminal.write(e)}markCodeAsUnsaved(){window.localStorage.setItem(te,"")}};var Ee=document.querySelector(".js-playground"),y=new z(Ee);y.registerAction("run",()=>{y.run()});y.registerAction("format",()=>{y.formatCode()});y.registerAction("share",()=>{y.shareCode()});y.registerAction("change-theme",()=>{y.changeTheme()});y.registerRunAsTestConsumer(()=>document.querySelector(".js-playground__action-run").getAttribute("data-type")==="Test");y.setupShortcuts();y.askLoadUnsavedCode();window.onload=()=>{let s=document.querySelector("html");s.style.opacity="1"};})();
